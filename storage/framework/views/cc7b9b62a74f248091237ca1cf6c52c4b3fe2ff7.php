  ...
  <nav role="navigation" class="menu"> 
    ...
    ?>
      ...
      <ul class="menu-dropdown">
        ...
        <li <?php if(Request::segment(2)!="" && (Request::segment(2)=='updatecard')): ?> class="active" <?php endif; ?>><a href="  <?php echo e(url('/')); ?>/seller/updatecard">Update Card Details </a><span class="icon idproof-verification-icn"></span></li>
