                            ...
                            <div class="int-profiles">
                                ...
                                <input type="file" class="form-control" id="front_image" name="front_image" data-max-file-size="2M" data-allowed-file-extensions="png jpg JPG jpeg JPEG" data-errors-position="outside" data-parsley-errors-container="#image_error"  
                                 <?php if(isset($user_details_arr['user_details']['front_image']) && $user_details_arr['user_details']['front_image']!='' && (file_exists(base_path().'/uploads/id_proof/'.$user_details_arr['user_details']['front_image']))): ?> 
                                  ...
                                  <?php else: ?> 
                                  required="" data-parsley-required-message="Please select front of id"<?php endif; ?>>
                            </div>

                       
                         <?php if(isset($user_details_arr['user_details']['front_image']) && $user_details_arr['user_details']['front_image']!='' && file_exists(base_path().'/uploads/id_proof/'.$user_details_arr['user_details']['front_image'])): ?>
                             <div class="uplaod-edit-img">
                              <img src="<?php echo e($id_proof_path.$user_details_arr['user_details']['front_image']); ?>" id="upload-f" class="profile" alt="Front of ID">
              ...
              <div class="form-group">
                ...
                <div class="col-md-9">
                    <div class="yprofiles">
                         ...
                         <?php if(isset($user_details_arr['user_details']['back_image']) 
                         && $user_details_arr['user_details']['back_image']!=''  && file_exists(base_path().'/uploads/id_proof/'.$user_details_arr['user_details']['back_image'])): ?>
                           <div class="uplaod-edit-img">
                              <img src="<?php echo e($id_proof_path.'/'.$user_details_arr['user_details']['back_image']); ?>" id="upload-f" class="profile" alt="Back of ID">
              ...
              <div class="form-group">
                ...
                <div class="col-md-9">
                    <div class="yprofiles">
                         ...
                         <?php if(isset($user_details_arr['user_details']['selfie_image']) && $user_details_arr['user_details']['selfie_image']!='' && file_exists(base_path().'/uploads/id_proof/'.$user_details_arr['user_details']['selfie_image'])): ?>
                           <div class="uplaod-edit-img">
                              <img src="<?php echo e($id_proof_path.'/'.$user_details_arr['user_details']['selfie_image']); ?>" id="upload-f" class="profile" alt="Selfie">
                    ...
                    <div class="yprofiles">
                         ...
                         <?php if(isset($user_details_arr['user_details']['address_proof']) && $user_details_arr['user_details']['address_proof']!='' && file_exists(base_path().'/uploads/id_proof/'.$user_details_arr['user_details']['address_proof'])): ?>
                             ...
                             ?>
                              ...
                              ?>
                                 <div class="uplaod-edit-img">
                                  <img src="<?php echo e($id_proof_path.'/'.$user_details_arr['user_details']['address_proof']); ?>" id="upload-f" class="profile" alt="Address Proof">                         
                                 </div> 
                              <?php
                                }//else
                              ?>
