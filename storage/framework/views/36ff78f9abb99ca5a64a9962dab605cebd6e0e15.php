   ...
   <div class="col-sm-12"> 
      <div class="white-box">
         ...
         <div class="pull-right">            
            ...
            <a href="<?php echo e(url($module_url_path.'/create')); ?>" class="btn btn-outline btn-info btn-circle show-tooltip btn-refresh" title="Add Product"><i class="fa fa-plus"></i> </a> 
