                       ...
                       <div class="myprofile-right">
                        ...
                        <?php if(!empty($arr_data['product_images_details']) && count($arr_data['product_images_details'])>0): ?>
                            <?php $__currentLoopData = $arr_data['product_images_details']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $images): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              ...
                              <?php if(file_exists(base_path().'/uploads/product_images/'.$images['image'])): ?>
                             
                            

                              <div class="disv-zooms" id="lightgallery2">
                               <a href="" data-responsive="<?php echo e($product_imageurl_path); ?>/<?php echo e($images['image']); ?>" data-src="<?php echo e($product_imageurl_path); ?>/<?php echo e($images['image']); ?>">
                                <img src="<?php echo e($product_imageurl_path); ?>/<?php echo e($images['image']); ?>" alt="Product Image" width="100"> 
                               </a>
                             </div>
                 ...
                 <div class="myprofile-main">
                  ...
                  <?php if(isset($arr_data['product_video_source']) && !empty($arr_data['product_video_source'])): ?>
                     <div class="myprofile-main">
                       ...
                       <div class="myprofile-right"> 
                         <a href="javascript:void(0)"  class="btn btn-info" style="background-color: #b833cc;border-color: #b833cc;" id="product_video_popup" data-video-source="<?php echo e($arr_data['product_video_source']); ?>" data-video-id="<?php echo e($arr_data['product_video_url']); ?>" data-video-title="<?php echo e(isset($arr_data['product_name'])? $arr_data['product_name']: ''); ?>" onclick="openProductVideoModal(this);">
                            View Video 
                          </a>
                       </div>
                      <div class="clearfix"></div>
