                                ...
                                <div class="col-sm-12 col-xs-12">
                                 ...
                                 <div class="form-group row">
                                  ...
                                  <div class="form-group row">
                                    ...
                                    <div class="col-md-10">                                       
                                       <textarea name="description" id="description" class="form-control" placeholder="Enter Description" data-parsley-required="true" data-parsley-required-message="Please enter description"> <?php echo e($arr_product['description']); ?></textarea> 
                                    </div>
                                    <script>
                                  ...
                                  <div class="form-group row" id="concentration_div"  <?php if(isset($db_cat_name) && $db_cat_name=="Essential Oils" || $db_cat_name=="Accessories"): ?> style="display: none" <?php else: ?> style="display: block" <?php endif; ?>>
                                    ...
                                    <div class="col-md-10">                                       
                                       ...
                                       <?php if(isset($db_cat_name) && !empty($db_cat_name) && $db_cat_name=="Essential Oils" || $db_cat_name=="Accessories"): ?> 
