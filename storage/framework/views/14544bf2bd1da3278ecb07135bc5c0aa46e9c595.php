...
<div class="my-profile-pgnm">
  <?php echo e(isset($page_title)?$page_title:''); ?>
      ...
      <ul class="breadcrumbs-my">
        ...
        <li>Pending Age Verification Orders</li>
      </ul>
<br/>
...
$(document).ready(function(){
    ...
    $("form").on("submit", function(event) {
        ...
        var URL = '<?php echo e(url('/seller/order')); ?>';
        ...
        
       {
         ...
         { 
           ...
           if(row.order_status == 'Ongoing')
           {
             ...
             return `<div class="status-dispatched">Pending Age Verification</div>`
