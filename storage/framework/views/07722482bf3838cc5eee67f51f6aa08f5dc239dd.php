            ...
            <div class="review-main-avatar">
                ...
                <div class="review-main-avatar-right">
                    ...
                    <div class="lisitng-detls-rate" title="<?php echo e($review['rating']); ?> Rating">
                        <img src="<?php echo e(url('/')); ?>/assets/front/images/<?php echo e(isset($img_rating)?$img_rating:'star-rate-ziro.svg'); ?>" alt="">                                
                    </div>
                    ...
                    <div class="commentofsub" id="hidecontent_<?php echo e($review['id']); ?>">
                        <?php if(isset($review['review']) && strlen($review['review'])>100): ?>
                            ...
                            <span class="show-more" style="color: #AE47DD;cursor: pointer;" onclick="return showmore(<?php echo e(isset($review['id'])?$review['id']:''); ?>)">See more</span>
                        <?php else: ?>
                        <?php 
                    ...
                    <?php
                        ...
                        echo ''; 
                    ?>
                    <span class="show-less" style="color:#AE47DD;cursor: pointer;" onclick="return showless(<?php echo e(isset($review['id'])?$review['id']:''); ?>)"  id="show-less_<?php echo e(isset($review['id'])?$review['id']:''); ?>">See less</span>
                </span>
