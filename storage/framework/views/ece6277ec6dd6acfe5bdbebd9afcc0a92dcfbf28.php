                        ...
                        <?php echo $__env->make('admin.layout._operation_status', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                            <div class="row">
                                <div class="col-sm-12 col-xs-12">
                                    ...
                                    <input type="hidden" name="id" id="id" value="<?php echo e(isset($arr_faq_category['id']) ? $arr_faq_category['id'] : ''); ?>" />


                                  <div class="form-group row">
                                    <label class="col-md-2 col-form-label" for="name">Category<i class="red">*</i></label>
                                    <div class="col-md-10">                                       
                                      <input type="text" name="faq_category" id="faq_category" class="form-control" data-parsley-required-message="Please enter faq category" data-parsley-required="true" value="<?php echo e(isset($arr_faq_category['faq_category']) ? $arr_faq_category['faq_category'] : ''); ?>">
                                    </div>
                                  </div>
                                  ...
                                  <div class="form-group row">
                                    <label class="col-md-2 col-form-label">Is Active</label>
                                      <div class="col-sm-6 col-lg-8 controls">
                                         ...
                                         <?php if(isset($arr_faq_category['is_active']) && $arr_faq_category['is_active']=="0"): ?> value="0"
                                         <?php elseif(isset($arr_faq_category['is_active']) && $arr_faq_category['is_active']==1): ?> value="1" 
                                         <?php endif; ?> data-size="small" class="js-switch " data-color="#99d683" data-secondary-color="#f96262" onchange="return toggle_status();"  <?php if(isset($arr_faq_category['is_active']) && $arr_faq_category['is_active'] =='1'): ?> checked="checked" <?php endif; ?> />
                                      </div>    
                                  </div>   
