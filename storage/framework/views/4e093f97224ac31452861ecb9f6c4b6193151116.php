...
<script type="text/javascript">
  ...
  $(document).ready(function()
  {
      ...
      {data: 'link', "orderable": true, "searchable":false},
      {
       render : function(data, type, row, meta) 
       {
  ...
  {
    var delete_param = "Tag";
    confirm_actions(ref,event,'Do you really want to delete this record?',delete_param);
  }

  function confirm_actions(ref,evt,msg,delete_param="")
 {
  var msg = msg || false;
               ...
               success: function(response)
               {
                 if(response.status=='SUCCESS'){
                   if(response.data=='ACTIVE')
                   {
                     ...
                     sweetAlert('success','Tag activated successfully','success');
                   ...
                   }else
                   {
                     ...
                     sweetAlert('success','Tag deactivated successfully','success');
                     location.reload(true);
                   }
                 }
                 else
