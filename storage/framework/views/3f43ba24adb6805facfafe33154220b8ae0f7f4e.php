                                        ...
                                        <li>
                                           <div class="checkbox clearfix">
                                              <div class="form-check checkbox-theme">
                                                  <input class="form-check-input" type="checkbox" value="anxiety.svg" id="rememberMe"  name="emoji[]">
                                          ...
                                          <li>
                                           <div class="checkbox clearfix">
                                              <div class="form-check checkbox-theme">
                                                  <input class="form-check-input" type="checkbox" value="focus.svg" id="rememberMe2"  name="emoji[]">
                                                  <label class="form-check-label" for="rememberMe2">
                                                     Focus
                                                     <img src='<?php echo url('/'); ?>/assets/images/focus.svg'>
                                                  </label>
                                              </div>
                                            </div>
                                          </li>
                                          <li>
                                           <div class="checkbox clearfix">
                                              <div class="form-check checkbox-theme">
                                                  <input class="form-check-input" type="checkbox" value="pain.svg" id="rememberMe3"  name="emoji[]">
                                                  <label class="form-check-label" for="rememberMe3">
                                                     Pain
                                                     <img src='<?php echo url('/'); ?>/assets/images/pain.svg'>
                                                  </label>
                                              </div>
                                            </div>
                                          </li>
                                          <li>
                                           <div class="checkbox clearfix">
                                              <div class="form-check checkbox-theme">
                                                  <input class="form-check-input" type="checkbox" value="sleep.svg" id="rememberMe4"  name="emoji[]">
                                                  <label class="form-check-label" for="rememberMe4">
                                                    Sleep
                                                     <img src='<?php echo url('/'); ?>/assets/images/sleep.svg'>
                                                  </label>
                                              </div>
                                            </div>
                                          </li>
                                          <li>
                                           <div class="checkbox clearfix">
                                              <div class="form-check checkbox-theme">
                                                  <input class="form-check-input" type="checkbox" value="skin.svg" id="rememberMe5"  name="emoji[]">
                                                  <label class="form-check-label" for="rememberMe5">
                                                    Skin 
                                                     <img src='<?php echo url('/'); ?>/assets/images/skin.svg'>
                                                  </label>
                                              </div>
                                            </div>
                                          </li>
