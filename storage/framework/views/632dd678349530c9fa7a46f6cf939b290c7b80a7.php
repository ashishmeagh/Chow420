...
<div class="main-my-profile">
   ...
   <div class="innermain-my-profile add-product-inrs space-o">
     <?php if($arr_product['is_approve']=="2" && isset($arr_product['reason']) && ($arr_product['reason']!="")): ?>
         <div class="order-id-main-left classordermain editproductstext-border"> 
          <span class="disapprovd-txt"><b>Disapproved Reason:</b></span> 
                <div class="productnames disapprove-reason" style="color:red"> 
   ...
   <div class="profile-img-block">
       ...
       <div class="row">
              ...
              <div class="col-md-12">
                  ...
                  <input type="hidden" name="prev_product_name" id="prev_product_name" value="<?php echo e($arr_product['product_name']); ?>">
                  <input type="hidden" name="product_name_flag" id="product_name_flag">
                  </div>
              </div>
              ...
              <div class="col-md-12">
                  ...
                  <input type="hidden" name="prev_sku" id="prev_sku" value="<?php echo e($arr_product['sku']); ?>">
                  <input type="hidden" name="sku_flag" id="sku_flag">
              </div>
             ...
             <div class="col-md-12">
                 <div class="form-group">
                    ...
                    <div id="brandList">
                     ...
                     <input type="hidden" name="prev_brand" id="prev_brand" value="<?php echo e(isset($brandname['name'])?$brandname['name']:''); ?>">
                     <input type="hidden" name="brand_flag" id="brand_flag">
                </div>
            </div>
            ...
            <div class="col-md-6">
                 <div class="form-group">
                    ...
                    <input type="hidden" name="prev_category" id="prev_category" value="<?php echo e(isset($arr_product['first_level_category_id']) ? $arr_product['first_level_category_id'] : ''); ?>">
                    <input type="hidden" name="category_flag" id="category_flag">
                </div>
            </div>
            <div class="col-md-6">
                 <div class="form-group">
                    ...
                    <div class="select-style">
                        ...
                        <input type="hidden" name="prev_sub_category" id="prev_sub_category" value="<?php echo e(isset($arr_product['second_level_category_id']) ? $arr_product['second_level_category_id'] : ''); ?>">
                        <input type="hidden" name="sub_category_flag" id="sub_category_flag"> 
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6">
              ...
              <input type="hidden" name="prev_price" id="prev_price" value="<?php echo e(num_format($arr_product['unit_price'],2)); ?>">
            ...
            <div class="col-md-6">
                ...
                <input type="hidden" name="prev_price_drop_to" id="prev_price_drop_to" value="<?php echo e(number_format($arr_product['price_drop_to'],2)); ?>" >
                <input type="hidden" name="price_drop_to_flag" id="price_drop_to_flag">
            </div>
              ...
              <div class="form-group">
                <label class="" for= "shipping_type"> Shipping Type <span class="red">*</span></label>                   
                  <div class="radio-btns radiobuttoninline">
                    ...
                    <input type="hidden" name="prev_shipping_type" id="prev_shipping_type" value="<?php echo e(isset($arr_product['shipping_type']) ? $arr_product['shipping_type'] : ''); ?>">
                    <input type="hidden" name="shipping_type_flag" id="shipping_type_flag">
            ...
            <div class="col-md-6" id="shipping_charges_block" <?php if($arr_product['shipping_type']=='1'): ?> style="display: block" <?php elseif($arr_product['shipping_type']=='0'): ?> style="display: none" <?php endif; ?>>
              <div class="form-group" >
                ...
                >
                <input type="hidden" name="prev_shipping_charges" id="prev_shipping_charges" value="<?php echo e(number_format($arr_product['shipping_charges'],2)); ?>">
                <input type="hidden" name="shipping_charges_flag" id="shipping_charges_flag">
            ...
            <div class="col-md-6">
                 <div class="form-group">
                    <label for="per_product_quantity">Shipping Duration (Days) <span>*</span></label>
                    ...
                    <input type="hidden" name="prev_shipping_duration" id="prev_shipping_duration" value="<?php echo e(isset($arr_product['shipping_duration'])?number_format($arr_product['shipping_duration'],1):''); ?>">
                    <input type="hidden" name="shipping_duration_flag" id="shipping_duration_flag">
            ...
            <div class="col-md-6">
                 <div class="form-group">
                    ...
                    <input type="hidden" name="prev_stock" id="prev_stock" value="<?php echo e($remainingstock); ?>">
                    <input type="hidden" name="stock_flag" id="stock_flag">
            ...
            <div class="col-md-6" id="concentration_div"  <?php if( (isset($db_cat_name) && $db_cat_name=="Essential Oils" || $db_cat_name=="Accessories") || (isset($db_spectrum_name) && $db_spectrum_name=="Hemp Seed") ): ?> style="display: none" <?php else: ?> style="display: block" <?php endif; ?>>
                 <div class="form-group">
                    ...
                    data-parsley-required-message="Please enter concentration" data-parsley-min-message="This value should be greater than or equal to 1">
                </div> 

                <input type="hidden" name="prev_quantity" id="prev_quantity" value="<?php echo e($arr_product['per_product_quantity']); ?>" >
                <input type="hidden" name="concentration_flag" id="concentration_flag">
            </div>
             ...
             <div class="col-md-6">
                 <div class="form-group">
                    ...
                    <div class="select-style">
                        ...
                        <input type="hidden" name="prev_spectrum" id="prev_spectrum" value="<?php echo e(isset($arr_product['spectrum']) ? $arr_product['spectrum'] : ''); ?>">
                        <input type="hidden" name="spectrum_flag" id="spectrum_flag">
                    </div>
                </div>
            </div>
             <div class="col-md-6">
 ...
 <?php 
  $prev_sel_cannabinoids = count($product_cannabinoid);
  $row_cnt = 1;
?>
            ...
            <div class="col-md-12" id="div_for_cannabinoids" <?php if(!isset($product_cannabinoid)): ?> style="display:none" <?php endif; ?>>
                ...
                <?php if(isset($product_cannabinoid) && count($product_cannabinoid) > 0): ?>
                  ...
                  <input type="hidden" name="prev_sel_cannabinoids" id="prev_sel_cannabinoids" value="<?php echo e(isset($prev_sel_cannabinoids) ? $prev_sel_cannabinoids : ''); ?>">

                  <input type="hidden" name="prev_sel_cannabinoids_flag" id="prev_sel_cannabinoids_flag">
            ...
            <?php else: ?>
              ...
              <div class="col-xs-5 col-sm-6 col-md-6 col-lg-6">
                  ...
                  <div class="select-style">
                    <select name="sel_cannabinoids[]" id="sel_cannabinoids<?php echo e($row_cnt); ?>" class="form-control sel_cannabinoids"  data-parsley-required-message="Please select cannabinoids" data-parsley-trigger="change" >
                    <option value="">Select cannabinoids</option>                                
                    <?php if(isset($cannabinoids_arr) && !empty($cannabinoids_arr)): ?>
                      <?php $__currentLoopData = $cannabinoids_arr; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cannabinoids): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="col-md-12">
                ...
                <input type="hidden" name="prev_description" id="prev_description" value="<?php echo e(isset($arr_product['description']) ? $arr_product['description'] : ''); ?>">
                <input type="hidden" name="description_flag" id="description_flag">
            </div> 
            ...
            <div class="col-md-12">
                 <div class="form-group">
                  ...
                  <input type="hidden" name="prev_ingredients" id="prev_ingredients" value="<?php echo e(isset($arr_product['ingredients']) ? $arr_product['ingredients'] : ''); ?>">
                    
                  <input type="hidden" name="ingredients_flag" id="ingredients_flag">                    
                </div>               
            </div> 
             ...
             <div class="col-md-12">
                 <div class="form-group">
                  ...
                  <input type="hidden" name="prev_suggested_use" id="prev_suggested_use" value="<?php echo e(isset($arr_product['suggested_use']) ? $arr_product['suggested_use'] : ''); ?>">
                    
                  <input type="hidden" name="suggested_use_flag" id="suggested_use_flag">                   
                </div>               
            </div> 
             ...
             <div class="col-md-12">
                 <div class="form-group">
                  ...
                  <input type="hidden" name="prev_amount_per_serving" id="prev_amount_per_serving" value="<?php echo e(isset($arr_product['amount_per_serving']) ? $arr_product['amount_per_serving'] : ''); ?>">
                    
                  <input type="hidden" name="amount_per_serving_flag" id="amount_per_serving_flag">
            ...
            <div class="col-md-12">
                <div class="form-group">
                  ...
                  <input type="hidden" name="prev_terpenes" id="prev_terpenes" value="<?php echo e(isset($arr_product['terpenes']) ? $arr_product['terpenes'] : ''); ?>">
                    
                  <input type="hidden" name="terpenes_flag" id="terpenes_flag">
             ...
             <div class="col-md-12">
               <div  id="dynamic_field" class="form-group">
                 ...
                 <!----------------------------code for showing multiple images-------------> 
                  ...
                  <input type="hidden" name="prev_product_img" id="prev_product_img" value="<?php echo e(isset($arr_product_image[0]['image']) ? $arr_product_image[0]['image'] : ''); ?>">
                  <input type="hidden" name="product_img_flag" id="product_img_flag">
               ...
               <div  id="dynamic_field" class="form-group">
                  ...
                  <div class="clone-divs edt-chow-view">
                    ...
                    <?php if((isset($db_cat_name) && $db_cat_name=="Essential Oils" || $db_cat_name=="Accessories") || (isset($db_spectrum_name) && $db_spectrum_name=="Hemp Seed")): ?> 
                     ...
                     <input type="hidden" name="prev_certificate_analysis" id="prev_certificate_analysis" value="<?php echo e(isset($arr_product['product_certificate']) ? $arr_product['product_certificate'] : ''); ?>">

                     <input type="hidden" name="certificate_flag" id="certificate_flag">
          ...
          <!--------------end-product-dimension------------------------------->
           ...
           <div class="col-md-4">
             <div class="form-group">
                ...
                <input type="hidden" name="prev_drop_shipper_name" id="prev_drop_shipper_name"  value="<?php echo e(isset($drop_shipper['name']) ?$drop_shipper['name']:''); ?>">
  
                <input type="hidden" name="drop_shipper_name_flag" id="drop_shipper_name_flag"> 
          ...
          <div class="col-md-4">
             <div class="form-group">
                ...
                <input type="hidden" name="prev_drop_shipper_email" id="prev_drop_shipper_email" value="<?php echo e(isset($drop_shipper['email']) ?$drop_shipper['email']:''); ?>">
                <input type="hidden" name="drop_shipper_email_flag" id="drop_shipper_email_flag">
           ...
           <div class="col-md-4">
             <div class="form-group">
                <label for="drop_shipper_product_price"> DropShipper Price ($)</label>
                 ...
                 <input type="text" name="drop_shipper_product_price" id="drop_shipper_product_price" class="input-text decimal" placeholder="Enter Dropshipper Price" data-parsley-type="number" data-parsley-maxlength="10" data-parsley-min="1" value="<?php echo e(isset($drop_shipper['product_price']) ?number_format($drop_shipper['product_price'],2):''); ?>">

                <input type="hidden" name="prev_drop_shipper_product_price" id="prev_drop_shipper_product_price" value="<?php echo e(isset($drop_shipper['product_price']) ?number_format($drop_shipper['product_price'],2):''); ?>">
                <input type="hidden" name="drop_shipper_product_price_flag" id="drop_shipper_product_price_flag">
             ...
             <div class="col-md-6">
                 <div class="form-group">
                    ...
                    <div class="select-style">
                        ...
                        <input type="hidden" name="prev_product_video_source" id="prev_product_video_source" value="<?php echo e(isset($arr_product['product_video_source']) ? $arr_product['product_video_source'] : ''); ?>">
                        <input type="hidden" name="product_video_source_flag" id="product_video_source_flag">
            ...
            <div class="col-md-6 product_video_url_div" <?php if($arr_product['product_video_source']=='youtube' || $arr_product['product_video_source']=='vimeo'): ?> style="display: block" data-parsley-required ='true' <?php else: ?> style="display: none" <?php endif; ?>>
                 <div class="form-group">
                    ...
                    <div class="select-style">
                        ...
                        <input type="hidden" name="prev_product_video_url" id="prev_product_video_url" value="<?php echo e(isset($arr_product['product_video_url']) ? $arr_product['product_video_url'] : ''); ?>">

                        <input type="hidden" name="product_video_url_flag" id="product_video_url_flag">
     ...
     <!--        <div class="col-md-12">
               <div  id="dynamic_field" class="form-group">
                  ...
                  <input type="hidden" name="prev_additional_product_img" id="prev_additional_product_img" value="<?php echo e(isset($arr_product['additional_product_image']) ? $arr_product['additional_product_image'] : ''); ?>">
            ...
            <div class="col-md-12">
                <div class="button-list-dts">
                    <button class="butn-def" id="btn_add" type="button">Update Product</button>
 ...
 $('#drop_shipper_name').keyup(function(){ 
    ...
    $('#btn_add').click(function()
    {
       ...
       var age_restriction = $("#age_restriction").val();  
        ...
        /*-------------------set flag for all fields when it changed---------------*/
        ...
        var brand                    = $("#brand").val();
        var first_level_category_id  = $("#first_level_category_id").val();
        var second_level_category_id = $("#second_level_category_id").val();
        var unit_price               = $("#unit_price").val();
        var price_drop_to            = $("#price_drop_to").val();

        var shipping_type            = $('input[name="shipping_type"]:checked').val();

        var shipping_charges         = $("#shipping_charges").val();
        var shipping_duration        = $("#shipping_duration").val();
        var product_stock            = $("#product_stock").val();
        var per_product_quantity     = $("#per_product_quantity").val();
        var spectrum                 = $("#spectrum").val();
        var description              = $("#description").val();
        var product_certificate      = $("#product_certificate").val();
        var drop_shipper_name        = $("#drop_shipper_name").val();
        var drop_shipper_email       = $("#drop_shipper_email").val();
        var drop_shipper_product_price = $("#drop_shipper_product_price").val();
        var product_video_source     = $("#product_video_source").val();
        var product_video_url        = $("#product_video_url").val();
        var product_image            = $("#product_image").val();

        var ingredients               = $("#ingredients").val();
        var suggested_use             = $("#suggested_use").val();
        var amount_per_serving        = $("#amount_per_serving").val();
        var terpenes                  = $("#terpenes").val();
        var product_additional_image  = $("#product_additional_image").val();
        var sel_cannabinoids = document.getElementsByName('sel_cannabinoids[]');


        //get previous values

         var prev_product_name         = $("#prev_product_name").val();
         var prev_sku                  = $("#prev_sku").val();
         var prev_brand                = $("#prev_brand").val();
         var prev_category             = $("#prev_category").val();
         var prev_sub_category         = $("#prev_sub_category").val();
         var prev_price                = $("#prev_price").val();
         var prev_price_drop_to        = $("#prev_price_drop_to").val();
         var prev_shipping_type        = $("#prev_shipping_type").val();
         var prev_shipping_charges     = $("#prev_shipping_charges").val();
         var prev_shipping_duration    = $("#prev_shipping_duration").val();
         var prev_stock                = $("#prev_stock").val();
         var prev_quantity             = $("#prev_quantity").val();
         var prev_spectrum             = $("#prev_spectrum").val();
         var prev_description          = $("#prev_description").val();
         var prev_certificate_analysis = $("#prev_certificate_analysis").val();
         var prev_drop_shipper_name    = $("#prev_drop_shipper_name").val();
         var prev_drop_shipper_email   = $("#prev_drop_shipper_email").val();
         var prev_drop_shipper_product_price = $("#prev_drop_shipper_product_price").val();
         var prev_product_video_source = $("#prev_product_video_source").val();
         var prev_product_video_url    = $("#prev_product_video_url").val();
         var prev_product_img          = $("#prev_product_img").val();

         var prev_ingredients             = $("#prev_ingredients").val();
         var prev_suggested_use           = $("#prev_suggested_use").val();
         var prev_amount_per_serving      = $("#prev_amount_per_serving").val();
         var prev_terpenes                = $("#prev_terpenes").val();
         var prev_additional_product_img  = $("#prev_additional_product_img").val();
         var prev_sel_cannabinoids        = $("#prev_sel_cannabinoids").val();


          if((ingredients).trim() != (prev_ingredients).trim())
          { 
             $("#ingredients_flag").val(1);
          }
          else
          { 
             $("#ingredients_flag").val(0);
          }

          if(sel_cannabinoids.length != prev_sel_cannabinoids)
          { 
            
             $("#prev_sel_cannabinoids_flag").val(1);
          }
          else
          {
            
             $("#prev_sel_cannabinoids_flag").val(0);
          }

          
          if((suggested_use).trim() != (prev_suggested_use).trim())
          {
             $("#suggested_use_flag").val(1);
          }
          else
          {
             $("#suggested_use_flag").val(0);
          }

          if((terpenes).trim() != (prev_terpenes).trim())
          {
            $("#terpenes_flag").val(1);
          }
          else
          ...
          if((amount_per_serving).trim() != (prev_amount_per_serving).trim())
          {
             $("#amount_per_serving_flag").val(1);
          }
          else{
             $("#amount_per_serving_flag").val(0);
          }

/*
          if(product_additional_image!='' && product_additional_image != prev_additional_product_img) 
          {
            $("#additional_product_img_flag").val(1);
          }
          else{
            $("#additional_product_img_flag").val(0);
          }*/
         
         if(product_name != prev_product_name)
         {
             $("#product_name_flag").val(1);
         }
         else
         {
            $("#product_name_flag").val(0);
         }
         ...
         if(first_level_category_id!=prev_category)
         {
            $("#category_flag").val(1);
         }
         else
         ...
         if(second_level_category_id!=prev_sub_category)
         {
            $("#sub_category_flag").val(1);
         }
         else
         {
            $("#sub_category_flag").val(0);
         }
         ...
         if(price_drop_to!=prev_price_drop_to)
         {
            $("#price_drop_to_flag").val(1);
         }
         else{
           $("#price_drop_to_flag").val(0);
         }


         if(shipping_type != prev_shipping_type)
         {
           $("#shipping_type_flag").val(1);

         }else{
            $("#shipping_type_flag").val(0);
         }


         if(shipping_charges != prev_shipping_charges)
         {
            $("#shipping_charges_flag").val(1);
         }
         else
         {
            $("#shipping_charges_flag").val(0);
         }

         if(shipping_duration!=prev_shipping_duration)
         { 
           $("#shipping_duration_flag").val(1);
         }else{
           $("#shipping_duration_flag").val(0);
         }

         if(product_stock != prev_stock)
         {
            $("#stock_flag").val(1);
         }
         else{
         ...
         if(per_product_quantity != prev_quantity)
         {
            $("#concentration_flag").val(1);
         }
         else{
           $("#concentration_flag").val(0);
         }
         ...
         { 
            $("#description_flag").val(1);
         }
         else{
           $("#description_flag").val(0);
         }

         if(product_certificate!='' && product_certificate != prev_certificate_analysis)
         {
            $("#certificate_flag").val(1);
         }else{
           $("#certificate_flag").val(0);
         }


         if(drop_shipper_name != prev_drop_shipper_name){
           $("#drop_shipper_name_flag").val(1);
         }else{
           $("#drop_shipper_name_flag").val(0);
         }

         if(drop_shipper_email != prev_drop_shipper_email)
         {
            $("#drop_shipper_email_flag").val(1);
         }else{
           $("#drop_shipper_email_flag").val(0);
         }


         if(drop_shipper_product_price != prev_drop_shipper_product_price){
            $("#drop_shipper_product_price_flag").val(1);
         }else{
           $("#drop_shipper_product_price_flag").val(0);
         }


         if(product_video_source != prev_product_video_source)
         {
            $("#product_video_source_flag").val(1);
         }else{
           $("#product_video_source_flag").val(0);
         }

         if(product_video_url != prev_product_video_url){
            $("#product_video_url_flag").val(1);
         }else{
           $("#product_video_url_flag").val(0);
         }

         if(product_image!='' && product_image != prev_product_img)
         {
            $("#product_img_flag").val(1);
         }
         else{
            $("#product_img_flag").val(0);
         }
        /*--------------------------------------------------------------------------*/
        ...
        $.ajax({                  
          ...
          success:function(data)
          {
             ...
             if('success' == data.status)
             {
                ...
                $("#showerr1").html('Only jpg,png,jpeg extenstions allowed');
...
function check_price_drop() {
    ...
    if(price_drop_to >= unit_price){
        ...
        $('#btn_add').attr('disabled',false);
           if(product_id!="" && price_drop_to > 0)
           { 
               var _token = $('input[name="_token"]').val();
               $.ajax({
                url:SITE_URL+'/seller/product/changed_drop_price',
                method:"POST",
...
<script type="text/javascript">
 ...
 function add_new_row(row_id){
  ...
  /*function remove_row(row_id,prod_can_id,prod_id,data){
     ...
     swal({
          title: 'Do you really want to delete this product cannabinoids ? ',
          type: "warning",
          showCancelButton: true,
