...
<div class="main-my-profile paddingnone">
  ...
  <div class="idprooftitle ">ID Proof Details</div>
   ...
   <div class="status-div-icon innermain-my-profile max-widnone">
        <div class="myprofile-lefts"> Verification Status </div>
          <?php if(isset($user_details_arr['user_details']['approve_verification_status']) && $user_details_arr['user_details']['approve_verification_status']==0): ?>
            <div class="myprofile-right">
              <div class="status-dispatched">Pending</div>
            </div>
          <?php elseif(isset($user_details_arr['user_details']['approve_verification_status']) && $user_details_arr['user_details']['approve_verification_status']==1): ?>
            <div class="myprofile-right">
              <div class="status-completed">Approved</div>
            </div>
          <?php elseif(isset($user_details_arr['user_details']['approve_verification_status']) && $user_details_arr['user_details']['approve_verification_status']==2): ?>
            <div class="myprofile-right">
              <div class="status-shipped">Rejected</div>
            </div>  
              <div class="main-rejects">
                <div class="myprofile-lefts">Reject Reason</div>
                 <div class="myprofile-right"><?php echo e(isset($user_details_arr['user_details']['note'])?$user_details_arr['user_details']['note']:''); ?>

                 </div>
               </div> 

          <?php elseif(isset($user_details_arr['user_details']['approve_verification_status']) && $user_details_arr['user_details']['approve_verification_status']==3): ?>
            <div class="myprofile-right">
  ...
  <input type="hidden" name="old_selfie_image" value="<?php echo e(isset($user_details_arr['user_details']['selfie_image']) ? $user_details_arr['user_details']['selfie_image'] : ''); ?>"> 
   
  <input type="hidden" name="old_addressproof_image" value="<?php echo e(isset($user_details_arr['user_details']['address_proof']) ? $user_details_arr['user_details']['address_proof'] : ''); ?>"> 
      <!----------------------------start of form of age verification------------->

      
        <?php if(isset($user_details_arr['user_details']['approve_verification_status']) && $user_details_arr['user_details']['approve_verification_status']==1): ?>
          <!------------------approved----------------------->
            ...
            <div class="row">      
                ...
                <div class="col-md-10">
                  <div class="yprofiles">
                    <div class="int-profiles">                                
                      <input type="file" class="form-control" id="front_image" name="front_image"  data-allowed-file-extensions="png jpg JPG jpeg JPEG" data-errors-position="outside" data-parsley-errors-container="#image_error"  <?php if(isset($user_details_arr['user_details']['front_image']) && $user_details_arr['user_details']['front_image']!=''  && file_exists(base_path().'/uploads/seller_id_proof/'.$user_details_arr['user_details']['front_image'])): ?> <?php else: ?> required="" data-parsley-required-message="Please select front of ID" <?php endif; ?>>
                    </div>
                    ...
                    <?php if(isset($user_details_arr['user_details']['front_image']) && $user_details_arr['user_details']['front_image']!=''): ?>
                        <div class="uplaod-edit-img">
                            <img src="<?php echo e($id_proof_path.$user_details_arr['user_details']['front_image']); ?>" id="upload-f" class="profile" alt="Front of ID" width="100" height="100">
              ...
              <div class="form-group">
                ...
                <div class="col-md-10">
                  <div class="yprofiles">
                    <div class="int-profiles">                            
                      <input type="file" class="form-control" id="back_image" name="back_image"  data-allowed-file-extensions="png jpg JPG jpeg JPEG" data-errors-position="outside" data-parsley-errors-container="#image_error" <?php if(isset($user_details_arr['user_details']['back_image']) && $user_details_arr['user_details']['back_image']!='' && file_exists(base_path().'/uploads/seller_id_proof/'.$user_details_arr['user_details']['back_image'])): ?> <?php else: ?> required="" data-parsley-required-message="Please select back of ID" <?php endif; ?>>
                    </div>

                    <?php if(isset($user_details_arr['user_details']['back_image']) && $user_details_arr['user_details']['back_image']!=''): ?>

                      <div class="uplaod-edit-img">
                        <img src="<?php echo e($id_proof_path.'/'.$user_details_arr['user_details']['back_image']); ?>" id="upload-f" class="profile" alt="Back of ID" width="100" height="100">
              ...
              <div class="form-group">
                ...
                <div class="col-md-10">
                  <div class="yprofiles">
                    <div class="int-profiles">                            
                        <input type="file" class="form-control" id="selfie_image" name="selfie_image"  data-allowed-file-extensions="png jpg JPG jpeg JPEG" data-errors-position="outside" data-parsley-errors-container="#image_error" <?php if(isset($user_details_arr['user_details']['selfie_image']) && $user_details_arr['user_details']['selfie_image']!='' && file_exists(base_path().'/uploads/seller_id_proof/'.$user_details_arr['user_details']['selfie_image'])): ?> <?php else: ?> required="required" data-parsley-required-message="Please select selfie" <?php endif; ?>>
                    </div>
                    <?php if(isset($user_details_arr['user_details']['selfie_image']) && $user_details_arr['user_details']['selfie_image']!=''): ?>

                      <div class="uplaod-edit-img">
                        <img src="<?php echo e($id_proof_path.'/'.$user_details_arr['user_details']['selfie_image']); ?>" id="upload-f" class="profile" alt="Selfie" width="100" height="100">
              ...
              <div class="form-group">
                ...
                <div class="col-md-10">
                  <div class="yprofiles">
                    <div class="int-profiles">                            
                        <input type="file" class="form-control" id="address_proof" name="address_proof"  data-allowed-file-extensions="png jpg JPG jpeg JPEG" data-errors-position="outside" data-parsley-errors-container="#image_error" <?php if(isset($user_details_arr['user_details']['address_proof']) && $user_details_arr['user_details']['address_proof']!='' && file_exists(base_path().'/uploads/seller_id_proof/'.$user_details_arr['user_details']['address_proof'])): ?> <?php else: ?> required="required" data-parsley-required-message="Please select address proof" <?php endif; ?>>
                    </div>
                    <?php if(isset($user_details_arr['user_details']['address_proof']) && $user_details_arr['user_details']['address_proof']!='' && file_exists(base_path().'/uploads/seller_id_proof/'.$user_details_arr['user_details']['address_proof'])): ?>
               ...
               <div class="form-group">
                    <div class="">
                     ...
                     <div class="col-md-10">
                      <div class="yprofiles">
                      <input type="text" id="age_address" name="age_address" value="<?php echo e(isset($user_details_arr['user_details']['age_address']) ? $user_details_arr['user_details']['age_address'] : ''); ?>" data-parsley-required="true" data-parsley-required-message="Please enter full address" class="input-text" placeholder="Address">
                        ...
                        <div class="details login-inr-fild">
                            ...
                            <?php echo e(csrf_field()); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="registered_name" id="registered_name" class="input-text" placeholder="Enter registered name" value="<?php echo e(isset($user_details_arr['user_details']['registered_name'])?$user_details_arr['user_details']['registered_name']:''); ?>"
                                 ...
                                 <div class="form-group">
                                    <label for="">Account Number <span>*</span></label>
                                     ...
                                     <input type="text" name="account_no" id="account_no" class="input-text" placeholder="Enter account number." value="<?php echo e(isset($user_details_arr['user_details']['account_no'])?$user_details_arr['user_details']['account_no']:''); ?>" 
                                     data-parsley-required="true"
                                ...
                                <div class="form-group">
                                    <label for="">Routing Number <span>*</span></label>
                                     ...
                                     <input type="text" name="routing_no" id="routing_no" class="input-text" placeholder="Enter routing number." value="<?php echo e(isset($user_details_arr['user_details']['routing_no'])?$user_details_arr['user_details']['routing_no']:''); ?>" 
                                     data-parsley-required="true"
                                 ...
                                 <div class="form-group">
                                    <label for="">Swift Number <span>*</span></label>
                                     ...
                                     <input type="text" name="switft_no" id="switft_no" class="input-text" placeholder="Enter switft number." value="<?php echo e(isset($user_details_arr['user_details']['switft_no'])?$user_details_arr['user_details']['switft_no']:''); ?>" 
                                     data-parsley-required="true"
                                 ...
                                 <div class="form-group">
                                    <label for="">Paypal Email <span></span></label>
                                     ...
                                     <input type="text" name="paypal_email" id="paypal_email" class="input-text" placeholder="Enter paypal email." value="<?php echo e(isset($user_details_arr['user_details']['paypal_email'])?$user_details_arr['user_details']['paypal_email']:''); ?>"                                       
          ...
          if(typeof response =='object')
          {
            if(response.status && response.status=="SUCCESS")
            {
              ...
              success_HTML +='<div class="alert alert-success alert-dismissible">\
                    ...
                    setTimeout(function(){
                       window.location.href="<?php echo e(url('/')); ?>/seller/bank_detail";
                    },4000);
