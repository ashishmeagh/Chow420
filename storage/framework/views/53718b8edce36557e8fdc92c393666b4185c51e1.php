...
<!-- End Google Tag Manager -->
    ...
    <link rel="mask-icon" href="<?php echo e(url('/')); ?>/assets/favicon/safari-pinned-tab.svg" color="#AE47DD">
    ...
    <div class="businessnamecls">
        <?php
            ...
            ?>
             ...
             <?php endif; ?>
             <a href="<?php echo e(url('/')); ?>/search?sellers=<?php echo e($business_name); ?>" target="_blank" class="viewstorecls btn btn-default" style="background-color: #AE47DD;color: #fff;border: 1px solid #AE47DD;text-decoration: none;">View Store</a>
    </div>
        ...
        <div class="favoirt-main notification-head-li">
            ...
            <div class="favoirt-main-li">
             <div class="notification">
                    ...
                    <a class="btn btn-info showreferaldropdown" style="width: 100%; min-width: 93px; background-color: #AE47DD;color: #fff;border: 1px solid #AE47DD;"> 
