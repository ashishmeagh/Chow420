...
<head>
    ...
    <title>Login - <?php echo e(config('app.project.name')); ?></title>
...
?>  
    ...
    <section id="wrapper" class="login-register">
        <div class="login-box">
            <div class="white-box">
             <form class="form-horizontal form-material" id="loginform" action="<?php echo e(url(config('app.project.admin_panel_slug').'/process_login')); ?>" method="POST" id="loginform">
                 ...
                 <div class="lgo-admin">
                    ...
                    <img src="<?php echo e($sitelogo); ?>" alt="Login" />
                    ...
                    <div class="form-group ">
                        <div class="col-xs-12">
                            <input class="form-control" type="text" value="<?php echo e(isset($_COOKIE["email"])?$_COOKIE["email"]:''); ?>" name="email" data-parsley-required="true" data-parsley-type="email" placeholder="Enter email" data-parsley-required-message="Please enter email">
                    ...
                    <div class="form-group">
                        <div class="col-xs-12">
                            ...
                            <input type="password" name="password" data-parsley-required="true" placeholder="Enter password" data-parsley-minlength="6" data-parsley-maxlength="16"  class="form-control" value="<?php echo e(isset($_COOKIE['password'])?$_COOKIE['password']:''); ?>" data-parsley-required-message="Please enter password">
                            <span class="red"><?php echo e($errors->first('password')); ?> </span>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-md-12">
                            <div class="checkbox checkbox-primary pull-left p-t-0">
                                <input id="checkbox-signup" type="checkbox" <?php if(isset($_COOKIE["rememberd"])&& $_COOKIE["rememberd"]=='rememberd'): ?> checked="checked" <?php endif; ?> name="remember_me">
                ...
                <form class="form-horizontal" method="post" id="recoverform" action="<?php echo e(url($admin_panel_slug.'/process_forgot_password')); ?>">
                    <?php echo e(csrf_field()); ?>
                    ...
                    <div class="form-group ">
                        <div class="col-xs-12">
                            ...
                            <span class="red" style="color:red"><?php echo e($errors->first('email')); ?></span>
                        </div>
                    </div>
                    <div class="form-group text-center m-t-20">
                        <div class="col-xs-12">
...
<script>
  ...
  setInterval(function(){ 
    $.ajax({
      url:'<?php echo e(url('/')); ?>'+'/check_loginattempt/verify_loginattempt',            
      data:{
        checkstat:1,              
      },
      dataType:'json',
