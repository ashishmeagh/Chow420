      ...
      <div class="subtotl-min text-left-price">
           ...
           <?php 
            ...
            <div class="gsttotal slrs-ttl-hitory">
               <div class="gst-left">Wallet Amount Used: </div>
                <div class="gst-right">$<?php echo e(isset($get_wallet_amountused_fororder)?num_format($get_wallet_amountused_fororder):'-'); ?></div>
                <div class="clearfix"></div>
            </div>
          ...
          <?php if(isset($product_arr['tax']) && $product_arr['tax'] != ''): ?>
            <div class="gsttotal slrs-ttl-hitory">
              ...
              <div class="gst-right">
              $<?php echo e(isset($product_arr['tax'])? number_format($product_arr['tax'],2):'-'); ?>
