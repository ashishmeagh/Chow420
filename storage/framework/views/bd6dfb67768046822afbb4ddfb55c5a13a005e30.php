                        ...
                        <div class="col-sm-6 col-lg-6 controls">
                          <select name="search_suggestion" id="search_suggestion" class="form-control column_filter" onchange="filterData()">
                            <option value="" selected>All</option>
                              <?php if(isset($arr_search_suggestion) && sizeof($arr_search_suggestion) >0): ?>
                                <?php $__currentLoopData = $arr_search_suggestion; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $suggestion): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                  <option 
                                    value="<?php echo e(isset($suggestion['id']) && $suggestion['id'] !='' ?$suggestion['id'] :''); ?>"><?php echo e(isset($suggestion['title']) && $suggestion['title'] !='' ? $suggestion['title'] : ''); ?>
