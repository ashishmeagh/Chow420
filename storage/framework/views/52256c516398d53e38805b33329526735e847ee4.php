    ...
    <div class="order-main-dvs table-order space-none-order-div">
      ...
      <div class="selr-wlts-head rw-selr-wlts-head flexnone">
        ...
        <div class="wallet-totl" title="">
         ...
         <div class="icon-wallets">
          ...
          <div class="inprogress-amount">           
            <span>$</span><?php echo e(isset($pending_wallet_amount) ? $pending_wallet_amount : ''); ?> 
          </div>
        ...
        <div class="wallet-totl" title="">
          ...
          <div class="price-wallet"><span>$</span> <?php echo e(isset($remain_wallet_amount) ? $remain_wallet_amount : ''); ?>
      ...
      <!-- <div class="selr-wlts-head rw-selr-wlts-head">
        ...
        <span>(Settled)</span>
         <div class="wallet-totl wallet-buyers-panel col-lg-3 col-md-3 col-sm-12" title="">
           ...
           <div class="icon-wallets">
              <img src="<?php echo e(url('/')); ?>/assets/seller/images/wallet-icon-seller-pg.png">
            </div>
            <div class="inprogress-amount">           
              <span>$</span> <?php echo e(isset($remain_wallet_amount) ? $remain_wallet_amount : ''); ?> 
