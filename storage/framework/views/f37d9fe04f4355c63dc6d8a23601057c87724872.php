  ...
  <?php
    ...
    ?>
     <div class="new-wrapper">
       ...
       <div class="sms-bank-details">To withdraw your funds, you must have id proof verified and your bank account details must be updated. Please follow <a href="<?php echo e(url('/')); ?>/seller/bank_detail" target="_blank">link</a> to update bank account details.</div>
...
?>
  ...
  <div class="new-wrapper">
    ...
    <div class="order-main-dvs table-order main-content-div">
      ...
      <div class="selr-wlts-head rw-selr-wlts-head">
        ...
        <div class="wallet-totl" title="In progress transactions are for products that have been shipped.Seller commission is <?php echo e($sellercommision); ?>% of sale">
         <div class="shippedorder-yellow">Shipped Orders (In Progress)</div>
         <div class="icon-wallets">
            <img src="<?php echo e(url('/')); ?>/assets/seller/images/wallet-inprogress .png" alt="" />
          </div>
          <div class="inprogress-amount">           
            <span>$</span> <?php echo e(isset($ship_wallet_amount)?num_format($ship_wallet_amount):'00.00'); ?>

              
          </div>
          <div class="clearfix"></div>    
          <div class="percent-wallets-yellow"><?php echo e($sellercommision); ?>% (excl. tax)</div>
        </div>




        <div class="wallet-totl" title="Dispensary commission : <?php echo e($sellercommision); ?>% of sale">
          ...
          <div class="price-wallet"><span>$</span>
            ...
            ?>
               <?php echo e(isset($showamt)?num_format($showamt):'00.00'); ?>


              
          </div>
          <div class="clearfix"></div>
          <div class="percent-wallets-green"><?php echo e($sellercommision); ?>% (excl. tax)</div>
        </div>
  ...
  <h3>Previous uncleared refund amount: $<?php echo e(isset($refund_balance_amount) ? $refund_balance_amount : ''); ?></h3>
  <h3>Referal uncleared wallet amount: $<?php echo e(isset($referal_wallet_amount) ? $referal_wallet_amount : ''); ?></h3>
...
<div class="withdrawal-request-txt">
   <?php
    ...
    ?>
     ...
     <button type="button" class="withdraw-btn" onclick="withdraRequest('Do you really want to send withdrawal request of amount $<?php echo e(isset($bothwallet_amount) ? $bothwallet_amount : ''); ?> ?')" >Withdraw</button>
    <?php    
    }
...
<script type="text/javascript"> var module_url_path  = "<?php echo e(isset($module_url_path) ? $module_url_path : ''); ?>";  </script>
 ...
 <script type="text/javascript">
  ...
  function withdraRequest(msg) {
    ...
    var referal_wallet_amount = '<?php echo e(isset($referal_wallet_amount) ? $referal_wallet_amount : ''); ?>';
        ...
        function(isConfirm,tmp)
        {
          if(isConfirm==true)
          {
            $.ajax({
              ...
              type:'POST',
              data:{_token:'<?php echo e(csrf_token()); ?>',wallet_amount:wallet_amount,seller_id:seller_id,referal_wallet_amount:referal_wallet_amount},
              dataType:'json',
              beforeSend: function() {
