     <!-- /.container-fluid -->
            <footer class="footer text-center"> <?php echo e(config('app.project.footer_link_year')); ?> &copy; <?php echo e(config('app.project.footer_link')); ?>, Inc.  </footer>
...
<!-- jQuery -->
    ...
    <script src="<?php echo e(url('/')); ?>/assets/admin/plugins/bower_components/sidebar-nav/dist/sidebar-nav.min.js"></script>
    <!--slimscroll JavaScript -->
    <script src="<?php echo e(url('/')); ?>/assets/admin/js/jquery.slimscroll.js"></script>
    <!--Wave Effects -->
    <script src="<?php echo e(url('/')); ?>/assets/admin/js/waves.js"></script>
    <!--Counter js -->
    <script src="<?php echo e(url('/')); ?>/assets/admin/plugins/bower_components/waypoints/lib/jquery.waypoints.js"></script>
    <script src="<?php echo e(url('/')); ?>/assets/admin/plugins/bower_components/counterup/jquery.counterup.min.js"></script>
    <!--Morris JavaScript -->
    <script src="<?php echo e(url('/')); ?>/assets/admin/plugins/bower_components/raphael/raphael-min.js"></script>
    
    <!-- Custom Theme JavaScript -->
    <script src="<?php echo e(url('/')); ?>/assets/admin/js/custom.min.js"></script>
    <script src="<?php echo e(url('/')); ?>/assets/admin/js/dashboard1.js"></script>
    <!-- Sparkline chart JavaScript -->
    <script src="<?php echo e(url('/')); ?>/assets/admin/plugins/bower_components/jquery-sparkline/jquery.sparkline.min.js"></script>
    <script src="<?php echo e(url('/')); ?>/assets/admin/plugins/bower_components/jquery-sparkline/jquery.charts-sparkline.js"></script>
    <script src="<?php echo e(url('/')); ?>/assets/admin/plugins/bower_components/toast-master/js/jquery.toast.js"></script>
    ...
    <script type="text/javascript" src="<?php echo e(url('/')); ?>/assets/admin/js/jquery-validation/dist/jquery.validate.min.js"></script>
    <script type="text/javascript" src="<?php echo e(url('/')); ?>/assets/admin/js/jquery-validation/dist/additional-methods.js"></script>
    <script src="<?php echo e(url('/')); ?>/assets/admin/js/validation.js"></script>
    ...
    <script type="text/javascript" src="<?php echo e(url('/')); ?>/assets/admin/js/Parsley/dist/parsley.min.js"></script>
    

    <script src="<?php echo e(url('/')); ?>/assets/admin/plugins/bower_components/dropify/dist/js/dropify.min.js"></script>
    ...
    <script type="text/javascript">
        ...
        function readNotifications(ref)
        {
          ...
          $.ajax({
                  ...
                  url:"<?php echo e(url('/')); ?>/notifications/read_notification",
                  type:'GET',
        ...
        /* setInterval(function(){ 
            $.ajax({
              url:'<?php echo e(url('/')); ?>'+'/check_queueemails/send_queueemails',            
              data:{
                checkstat:1,              
              },
              dataType:'json',
     ...
     <!--Style Switcher -->
    <script src="<?php echo e(url('/')); ?>/assets/admin/plugins/bower_components/styleswitcher/jQuery.style.switcher.js"></script>
    <!--Style Switcher -->
    <script src="<?php echo e(url('/')); ?>/assets/admin/plugins/bower_components/styleswitcher/jQuery.style.switcher.js"></script>
    <!--Parsley Js-->
    <script type="text/javascript" src="<?php echo e(url('/')); ?>/assets/admin/js/Parsley/dist/parsley.min.js"></script>
