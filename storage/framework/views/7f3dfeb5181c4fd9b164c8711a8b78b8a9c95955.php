...
<div id="page-wrapper">
            ...
            <div class="col-sm-12">
              ...
              <?php if(isset($arr_data['site_setting_id'])): ?>
                <?php echo Form::open([ 
                     ...
                     'url' => $module_url_path.'/update_header/'.base64_encode($arr_data['site_setting_id']),
                     'method'=>'POST',   
              ...
              <?php else: ?> 
                  <?php echo Form::open([ 
                     ...
                     'url' => $module_url_path.'/update_header/0',
                     'method'=>'POST',   
                     'class'=>'form-horizontal', 
                     'id'=>'validation-form',
                     'enctype' =>'multipart/form-data'
              ...
              <?php endif; ?>
               ...
               <div class="row"> 
                    ...
                    <div class="form-group row">
                        <label class="col-md-2 col-form-label" for="description">Header<i class="red">*</i></label>
                        <div class="col-md-10">                                       
                           <textarea name="description" id="description" class="form-control" placeholder=""  ><?php echo e(isset($arr_data['highlight_header']) ? $arr_data['highlight_header'] : ''); ?></textarea>
                           <script>
    ...
    $(document).ready(function(){
       ...
       $("#btn_update").click(function(event) {        
            ...
            if(ckeditor_title == ""){
                $(".error_title").html("Please enter header");
               return false;
            } else {
              return true;
            }
