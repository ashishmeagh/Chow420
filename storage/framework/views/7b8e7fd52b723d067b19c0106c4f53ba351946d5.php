   ...
   <div class="col-sm-12"> 
      <div class="white-box">
         ...
         <div class="pull-right">            
            ...
            <?php if(isset($get_highlights) && count($get_highlights)<=2): ?>
               <a href="<?php echo e(url($module_url_path.'/create')); ?>" class="btn btn-outline btn-info btn-circle show-tooltip btn-refresh" title="Add Highlight"><i class="fa fa-plus"></i> </a> 
            <?php endif; ?>
