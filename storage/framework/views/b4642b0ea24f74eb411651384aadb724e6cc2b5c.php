            ...
            <div class="white-box">
               ...
               <div class="row"> 
                  <div class="col-sm-12 col-xs-12">
                     ...
                     <div class="form-group">
                        <label class="col-sm-12 col-md-4 col-lg-2 control-label">Send new policies<i class="red">*</i></label>
                        <div class="col-sm-12 col-md-12 col-lg-10">                         
                          <a class="btn btn-success" href="<?php echo e(url('/')); ?>/<?php echo e(config('app.project.admin_panel_slug')); ?>/site_settings/updatepolicy">Request Acceptance of New Policies</a>
                        </div>
                     </div>
