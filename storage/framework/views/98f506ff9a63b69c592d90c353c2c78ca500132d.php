                                        ...
                                        <select name="second_level_category_id" id="second_level_category_id" class="form-control" data-parsley-required ='true' data-parsley-required-message="Please select sub category">
                                            <option value="">Select sub category</option>
                                              <?php $__currentLoopData = $arr_secondcategory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e(isset($cat['id']) ? $cat['id'] : ''); ?>"><?php echo e(isset($cat['name']) ? $cat['name'] : ''); ?></option>
                                              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                         </div>
                                  </div>
                            ...
                            <div class="col-md-12 flex-mobile" style="padding:10px;border: 1px solid #d1d1d1; border-bottom:none;">
                              ...
                              <div class="col-md-12 flex-mobile" style="padding:10px;border: 1px solid #d1d1d1;" id="row_cannabinoids<?php echo e($row_cnt); ?>">
                                      <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                                          <select name="sel_cannabinoids[]" id="sel_cannabinoids<?php echo e($row_cnt); ?>" class="form-control sel_cannabinoids" data-parsley-required ='true'  data-parsley-required-message="Please select cannabinoids" 
                                          onchange="check_duplicate_cannabinoids(this.id,this.value,<?php echo e($row_cnt); ?>)">
                                      ...
                                      <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                                        <input type="text" name="txt_percent[]" id="txt_percent<?php echo e($row_cnt); ?>" class="form-control txt_percent" data-parsley-required ='true'  placeholder="%" value="" data-parsley-trigger="keyup"    
                         ...
                         <div class="clearfix"></div>
                                  ...
                                  <div class="form-group row" id="coa_div">
                                    ...
                                    <div class="col-md-10">
                                      ...
                                      <div  id="dynamic_field">
                                          ...
                                          <span id="product_certificate_error"><?php echo e($errors->first('product_certificate')); ?></span>
                                        </div>
                                  ...
                                  <div class="form-group row">
                                    ...
                                    <div class="col-md-10">                                       
                                      ...
                                      <span class="price_drop_er_msg"><?php echo e($errors->first('price_drop_to')); ?></span>  
                                    </div>
                                  ...
                                  <div class="form-group row">
                                    ...
                                    <div class="col-md-10">                                       
                                       ...
                                       >
                                        <span id="product_stock_err"><?php echo e($errors->first('product_stock')); ?></span>
                                    </div>
