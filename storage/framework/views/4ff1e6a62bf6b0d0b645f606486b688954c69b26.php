          ...
          <div class="row bg-title">
              ...
              <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12"> 
                  <ol class="breadcrumb">
                      ...
                      <li class="active">Duplicate Product</li>
                  </ol>
              </div> 
              <!-- /.col-lg-12 -->  
          </div> 
    ...
    <!-- .row -->
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-xs-12">
                                  ...
                                  <div class="form-group row">
                                    ...
                                    <div class="col-md-10">                                       
                                       <input type="text" name="product_name" id="product_name" class="form-control" placeholder="'Brand name' 'spectrum' 'CBD' 'product category' 'product flavor (if any)' 'product milligrams'" value="<?php echo e($arr_product['product_name']); ?>" data-parsley-required ='true' data-parsley-required-message="Please enter product name" 
                                       >
                                                ...
                                                <?php $__currentLoopData = $product_cannabinoid; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $productCannabinoid): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <div class="col-md-12 flex-mobile" style="padding:10px;border: 1px solid #d1d1d1;" id="row_cannabinoids<?php echo e($row_cnt); ?>">
                                                          ...
                                                          <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                                                              <input type="text" name="txt_percent[]" id="txt_percent<?php echo e($row_cnt); ?>" class="form-control txt_percent" placeholder="%" value="<?php echo e($productCannabinoid['percent']); ?>" data-parsley-trigger="keyup"   
                                  ...
                                  <div class="form-group row">
                                   ...
                                   <div class="form-group row">
                                    <label class="col-md-2 col-form-label" for="description">Ingredients</label>
                                    <div class="col-md-10">                                       
                                    ...
                                    <div class="form-group row">
                                    <label class="col-md-2 col-form-label" for="description">Suggested Use</label>
                                    <div class="col-md-10">                                       
                                    ...
                                    <div class="form-group row">
                                    <label class="col-md-2 col-form-label" for="description">Amount per serving</label>
                                    <div class="col-md-10">                                       
                                  ...
                                  <div class="form-group row">
                                    ...
                                    <input type="hidden" name="old_img" id="old_img" value="<?php echo e(isset(
                                      $arr_product_image[0]['image'])?$arr_product_image[0]['image']:
                                      ''); ?>">

                                    <input type="file" name="product_image" id="product_image"  data-max-file-size="2M" class="dropify" data-default-file=" <?php if(isset($arr_product_image[0]['image'])): ?>
                                    <?php echo e($product_public_img_path); ?><?php echo e($arr_product_image[0]['image']); ?> 
                                    <?php else: ?> <?php endif; ?>">
                                  ...
                                  <div class="form-group row" id="coa_link_div"  <?php if( (isset($db_cat_name) && $db_cat_name=="Essential Oils" || $db_cat_name=="Accessories") || (isset($db_spectrum_name) && $db_spectrum_name=="Hemp Seed")): ?> style="display: none" <?php else: ?> style="display: block" <?php endif; ?>>
                                    <label class="col-md-2 col-form-label" for="coa_link">COA Link<i class="red"></i></label>
                                    <div class="col-md-10">             
                                       <input type="text" data-parsley-type="url" name="coa_link" id="coa_link" class="form-control"placeholder="Enter COA Link"  data-parsley-required-message="Please enter the coa link"  value="<?php echo e($arr_product['coa_link']); ?>"  >
                                       <span id="coa_link_url_err"><?php echo e($errors->first('coa_link')); ?></span>
                                    </div>                                      
                                  </div> 
                                ...
                                <div class="form-group row">
                                    <label class="col-md-2 col-form-label" for="shipping_duration">Shipping Duration (Days)<i class="red">*</i></label>
                                    <div class="col-md-10">                                       
           ...
           <!----------start-product-dimension----------------------->                       
              ...
              <!-------------end-product-dimension--------------------------->
                                   ...
                                   <div class="form-group row">
                                      <label for="user_id" class="col-md-2 col-form-label">Seller Name<i class="red">*</i></label>
                                      <div class="col-md-10">
                                        <select  name="user_id" id="user_id" class="form-control" data-parsley-required ='true' data-parsley-required-message="Please select seller name">
                                  ...
                                  <hr>
                                    <div class="form-group row">
                                      <label class="col-md-2 col-form-label" for="product_stockdrop">  Drop Shipping <i class="fa fa-question-circle" aria-hidden="true" title="Add your dropshipper or supplier information so we can forward your orders to their email automatically. You will be copied on all emails forwarded to your dropshipper"></i></label>
                                    </div>  
                                  ...
                                  <div class="form-group row">
                                    ...
                                    <div class="col-md-4">                                       
                                       <input type="email" name="drop_shipper_email" id="drop_shipper_email" class="form-control" placeholder="Enter DroppShipper Email" data-parsley-type="email" value="<?php echo e(isset($drop_shipper['email']) ?$drop_shipper['email']:''); ?>"  <?php if(isset($drop_shipper['email'])): ?> readonly="readonly" <?php endif; ?>>
                                  ...
                                  <div class="form-group row" id="concentration_div" <?php if((isset($db_cat_name) && $db_cat_name=="Essential Oils" || $db_cat_name=="Accessories")||(isset($db_spectrum_name) && $db_spectrum_name=="Hemp Seed")): ?> style="display: none" <?php else: ?> style="display: block" <?php endif; ?>>
                                    ...
                                    <div class="col-md-10">                                       
                                       ...
                                       <?php else: ?>
                                        data-parsley-required="true" 
                                        <?php endif; ?>
                                        data-parsley-min-message="This value should be greater than or equal to 1"
                                  ...
                                  <div class="form-group row product_video_url_div" id="product_video_url_div" <?php if($arr_product['product_video_source']=='youtube' || $arr_product['product_video_source']=='vimeo'): ?> style="display: block" data-parsley-required ='true' <?php else: ?> style="display: none" <?php endif; ?>>
                                   ...
                                   <div class="form-group row">
                                      ...
                                      <div class="col-md-10">
                                         <input type="text" name="product_rating" id="product_rating" class="form-control" placeholder="Enter Rating" value="<?php echo e(isset($arr_product['avg_rating']) ? $arr_product['avg_rating'] : ''); ?>">
                                     </div>
                                  </div>
                                  ...
                                  <div class="form-group row">
                                      ...
                                      <div class="col-md-10">
                                        <input type="text" name="product_review" id="product_review" class="form-control"  placeholder="Enter Review" value="<?php echo e(isset($arr_product['avg_review']) ? $arr_product['avg_review'] : ''); ?>">
                                     </div>
                                  </div>
                       ...
                       <!--          <div class="form-group row">
                                ...
                                <button type="submit" class="btn btn-success waves-effect waves-light m-r-10" value="Add" id="btn_add">Duplicate Product</button>
    ...
    $('#btn_add').click(function()
    {
      ...
      // formdata.set('description',ckeditor_description); 
        $.ajax({
            ...
            url: module_url_path+'/copy_product_save',
            data: formdata,
            contentType:false,
            processData:false,
            method:'POST',
