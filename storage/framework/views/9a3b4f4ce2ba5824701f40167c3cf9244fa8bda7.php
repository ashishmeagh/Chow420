                     ...
                     <h4> <span id="showerr"></span> </h4>
                        ...
                        <?php echo $__env->make('admin.layout._operation_status', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                            <div class="row">
                                <div class="col-sm-12 col-xs-12">
                                    ...
                                    <div class="col-md-10">                                       
                                      <div class="ratings-frms rating-space-top">
                                           <div class="starrr text-left">
                                             <input name="rating" id="rating" class="star required" type="radio"  value="<?php echo e(isset($arr_product['rating'])?$arr_product['rating']:'1'); ?>"/>
                                          </div>
                                      </div>
                                    </div>
                                  ...
                                  <div class="form-group row">
                                    ...
                                    <div class="col-md-10">                                       
                                       ...
                                       <?php if(isset($arr_product['buyer_id']) && $arr_product['buyer_id']==0): ?> data-parsley-required ='true' <?php else: ?>   <?php endif; ?>
                                       
                                       data-parsley-required-message="Please enter user name" value="<?php echo e(isset($arr_product['user_name']) ? $arr_product['user_name'] : ''); ?>">
                                   ...
                                   <div class="form-group row">
                                    ...
                                    <div class="col-md-10">                                       
                                       <input type="text" name="title" id="title" class="form-control" placeholder="Enter Title" data-parsley-required ='true' data-parsley-required-message="Please enter title" value="<?php echo e(isset($arr_product['title']) ? $arr_product['title'] : ''); ?>">
                                   ...
                                   <div class="form-group row">
                                    ...
                                    <div class="col-md-10">                                       
                                       <textarea name="review" id="review" class="form-control" placeholder="Enter Review" data-parsley-required ='true' data-parsley-required-message="Please enter review" ><?php echo e(isset($arr_product['review']) ? $arr_product['review'] : ''); ?>
                                   ...
                                   <?php 
                                     $emjiarr = []; 
                                     $emojis = isset($arr_product['emoji'])?$arr_product['emoji']:'';
                                     if(isset($emojis) && !empty($emojis))
                                     {
                                      $emjiarr = explode(",", $emojis);
                                        ...
                                        <li>
                                           <div class="checkbox clearfix">
                                              <div class="form-check checkbox-theme">
                                                  <input class="form-check-input" type="checkbox" value="anxiety.svg" id="rememberMe"  name="emoji[]" <?php if(isset($emjiarr) && !empty($emjiarr) && in_array("anxiety.svg", $emjiarr)): ?> checked="checked" <?php endif; ?>>
                                                  <label class="form-check-label" for="rememberMe">
                                                     Anxiety
                                                     <img src='<?php echo url('/'); ?>/assets/images/anxiety.svg' />
                                                  </label>
                                              </div>
                                            </div>
                                          </li> <?php */ ?>
                                         ...
                                         <?php if(isset($get_reported_effects) && !empty($get_reported_effects)): ?>
                                             <?php $__currentLoopData = $get_reported_effects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                              <li>
                                               <div class="checkbox clearfix">
                                                  <div class="form-check checkbox-theme">
                                                      <input class="form-check-input" type="checkbox" value="<?php echo e($v['id']); ?>" id="rememberMe2<?php echo e($v['id']); ?>"  name="emoji[]" <?php if(isset($emjiarr) && !empty($emjiarr) && in_array($v['id'], $emjiarr)): ?> checked="checked" <?php endif; ?>>
                                                      <label class="form-check-label" for="rememberMe2<?php echo e($v['id']); ?>"  >
                                ...
                                <button type="submit" class="btn btn-success waves-effect waves-light m-r-10" value="Edit" id="btn_add">Edit</button>
