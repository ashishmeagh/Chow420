...
<div class="new-wrapper">
  <div class="button-list-dts myproduct-mrg">
    ...
    <?php if(isset($arr_seller) && count($arr_seller) > 0 && ($arr_seller['approve_status'] == 1) && isset($user_arr) && ($user_arr['approve_status']==1) ): ?>


     <?php if(isset($user_subscriptionstatus) && $user_subscriptionstatus=='1'): ?> 
            ...
            // elseif($user_product_count<=$user_product_limit)
             elseif($res_active_product_count<=$product_limit)
             {
              ...
              ?>
                    ...
                    <?php if(isset($seller_documents_verification_status) && $seller_documents_verification_status=='0'): ?> 
                       <a href="#" class="butn-def cancelbtnss" data-toggle="modal" data-target="#documentsNotUploaded" data-backdrop="false" style="color: #fff;
    background-color: #873dc8;border-color: #873dc8;">Add Product</a>

                   <?php elseif(isset($seller_documents_verification_status) && $seller_documents_verification_status=='2'): ?> 

                        <a href="#" class="butn-def cancelbtnss" data-toggle="modal" data-target="#documentsRejected" data-backdrop="false" style="color: #fff;
    background-color: #873dc8;border-color: #873dc8;">Add Product</a>

                      <?php elseif(isset($seller_documents_verification_status) && $seller_documents_verification_status=='3'): ?> 

                        <a href="#" class="butn-def cancelbtnss" data-toggle="modal" data-target="#documentsSubmitted" data-backdrop="false" style="color: #fff;
    background-color: #873dc8;border-color: #873dc8;">Add Product</a>

                       <?php elseif(isset($seller_documents_verification_status) && $seller_documents_verification_status=='1'): ?> 

                      
                       <a href="<?php echo e(url('/')); ?>/seller/product/create" class="butn-def cancelbtnss" style="color: #fff;
    background-color: #873dc8;border-color: #873dc8;">Add Product</a> 
        ...
        <?php elseif($user_subscriptionstatus!='1' && isset($get_cancelmembershipdata) && 
    ...
    background-color: #873dc8;border-color: #873dc8;">Add Product</a> 
     ...
     <?php elseif($user_subscriptionstatus!='1' && isset($user_subscriptiontabledata) && !empty($user_subscriptiontabledata) && $user_subscriptiontabledata[0]['membership']=="1"): ?>   
          <!---------Free membership----------->
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content" >
          <button type="button" class="close" data-dismiss="modal">
            <img src="<?php echo e(url('/')); ?>/assets/seller/images/closbtns.png" alt="" /> </button>
            <div class="ordr-calltnal-title"> Please select membership plan .</div>
            <div class="button-list-dts btn-order-cnls okbuttons">
              <a href="<?php echo e(url('/')); ?>/seller/membership" class="btns-pending">
                 OK
              </a>
            </div>
        </div>
    ...
    <div class="modal-dialog my-product-add-chow">
        ...
        <div class="modal-content" >
          <button type="button" class="close" data-dismiss="modal">
            ...
            <div class="button-list-dts btn-order-cnls okbuttons">
              <a href="<?php echo e(url('/')); ?>/seller/profile" class="btns-pending">
                 OK
              </a>
            </div>
        </div>
        ...
        <div class="modal-content">
            ...
            <div class="business-details-main-dv seller-pflviw">
               <form method="post" enctype="multipart/form-data" id="form_import">
                        ...
                        <div class="input-group ">
                            ...
                            <div class="btn btn-primary btn-file btn-gry">
                                <a class="file" onclick="browseImage(this)">
                                    <img src="<?php echo e(url('/')); ?>/assets/seller/images/upload-add-busines.png" alt=""  />
                                </a>
                            </div>
                ...
                <a class="download-template" href="<?php echo e(url('/')); ?>/seller/product/exportExcel" >Download Template </a>
              </div>
...
<script type="text/javascript">
  ...
  var module_url_path ="<?php echo e(url('/')); ?>/seller/product"
