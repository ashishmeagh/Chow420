  ...
  <div class="col-md-4 col-lg-offset-2 col-md-offset-2 new-customer-box">
    ...
    <form method="POST" id="signup-form">
       ...
       <div class="flex-list-left-bn">
               ...
               <input type="email" name="email" id="email" class="form-control" placeholder="Email Address" data-parsley-required="true" data-parsley-type="email" data-parsley-type-message="Please enter valid email address" data-parsley-required-message="Please enter email address" value="<?php echo e(isset($email) ? $email : ''); ?>" data-parsley-required-message="Please enter email" />
