...
<script type="text/javascript">
  ...
  $(document).ready(function()
  {
      ...
      {data: 'video_url', "orderable": true, "searchable":false},
      {
       render : function(data, type, row, meta) 
       {
    ...
    $('#table_module').on('draw.dt',function(event)
    {
      ...
      $("input.toggleFeatured").change(function(){
          featuredstatusChange($(this));
       });   
    ...
    /*search box*/
     $("#table_module").find("thead").append(`<tr>
                    ...
                    <td><input type="text" name="q_image_url" id="q_image_url" placeholder="Search" class="search-block-new-table column_filter form-control" /></td>
                    <td>
  ...
  function statusChange(data)
   ...
   function featuredstatusChange(data)
   {
     var type = data.attr('data-type');
    
     if(type=="featured")
     {
      var title =  'Do you really want to make the status of this record as featured?';
     }else if(type=="unfeatured")
     {
      var title =  'Do you really want to make the status of this record as unfeatured?';
     }
