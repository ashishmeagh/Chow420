...
?>
         <!---------------------start of similar product------------------------------>
             ...
             <?php if(isset($arr_similar_product) && !empty($arr_similar_product)): ?>
              ...
              <div class="border-home-brfands"></div>
               ...
               <div class="clearfix"></div>
                <div class="featuredbrands-flex sml-fnt-sldr">
                   <ul 
                   <?php if(isset($arr_similar_product) && count($arr_similar_product)<=$device_count): ?>
                    class="similarproduct"
                   <?php elseif(isset($arr_similar_product) && count($arr_similar_product)>$device_count): ?>
                   ...
                   >      
                    ...
                    ?>
                    <?php $__currentLoopData = $arr_similar_product; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>                     
                      <?php  
                                        ...
                                        <?php if(!empty($product['product_images_details']) 
                                         && count($product['product_images_details'])  && file_exists(base_path().'/uploads/product_images/'.$product['product_images_details'][0]['image'])): ?>
                                          ...
                                          ?>
                                            ...
                                            <img data-src="<?php echo e($similar_product_image); ?>" src="<?php echo e(url('/assets/images/Pulse-1s-200px.svg')); ?>" class="portrait lozad" alt="<?php echo e($product['product_name']); ?>" />
