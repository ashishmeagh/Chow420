...
<!-- BEGIN Page Title -->
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(url('/')); ?>/assets/common/css/smartphoto.min.css">
   ...
   <div class="col-sm-12">
      <div class="white-box">
         ...
         <div class="pull-right">
            <a href="<?php echo e($module_url_path.'/create'); ?>" class="btn btn-outline btn-info btn-circle show-tooltip btn-refresh" title="Add New <?php echo e(str_singular($module_title)); ?>"><i class="fa fa-plus"></i> </a> 
...
<div class="modal fade" id="show_age_section" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog maxwdths" role="document">
    ...
    <input type="hidden" name="age_verification_age_category" id="age_verification_age_category" value="">
     ...
     <input type="hidden" name="age_verification_buyername" id="age_verification_buyername" value="">
              ...
              <div class="row">
                   <div class="col-md-12">
                    <div class="div-class-ind">
                      <div class="title-imgd">Name</div>
                      <div class="img-forntsimg" id="buyername_div"></div>
...
<script type="text/javascript" src="<?php echo e(url('/')); ?>/assets/common/js/smartphoto.js?v=1""></script>

<!-- END Main Content -->
<script type="text/javascript">
   var module_url_path         = "<?php echo e($module_url_path); ?>";
   var base_url = "<?php echo e(url('/')); ?>";
   var user_id_proof = "<?php echo e($user_id_proof); ?>";
...
// for view age details
     $(document).on("click",".view_age_section",function() { 
...

      {
          ...
          $("#age_verification_buyername").val(buyername);
          if(buyername.trim()!='')
          {
            $("#buyername_div").html(buyername);
          }else{
            $("#buyername_div").html('NA');
          }
