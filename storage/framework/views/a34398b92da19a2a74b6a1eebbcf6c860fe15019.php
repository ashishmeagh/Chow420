...
<!-- End Google Tag Manager -->
    ...
    <!-- Bootstrap CSS -->
    <link href="<?php echo e(url('/')); ?>/assets/buyer/css/bootstrap.css" rel="stylesheet" type="text/css" />
    <!--font-awesome-css-start-here-->
    <link href="<?php echo e(url('/')); ?>/assets/buyer/css/font-awesome.min.css" rel="stylesheet" type="text/css" />
    <!--Custom Css-->
    <link href="<?php echo e(url('/')); ?>/assets/buyer/css/chow.css" rel="stylesheet" type="text/css" />
    <link href="<?php echo e(url('/')); ?>/assets/buyer/css/afterlogin-css.css" rel="stylesheet" type="text/css" />
    ...
    <!--Main JS-->
    <script type="text/javascript" src="<?php echo e(url('/')); ?>/assets/buyer/js/jquery-1.11.3.min.js"></script>
    <!--[if lt IE 9]>-->
...
$show_policies_popup = 0;
$check_policies_updated = check_policies();
 if(isset($login_user) && $login_user==true && isset($check_policies_updated))
 {

  $get_user_createdat = get_login_userinfo();


   if(isset($get_user_createdat) && !empty($get_user_createdat))
   {
     if($check_policies_updated>$get_user_createdat['user_created'] && $get_user_createdat['is_policy_accepted']==0)
     {
       $show_policies_popup = 1;
     }
   }
 }  
 ...
 <div class="header-afterlogin">
  <span class="buttonclose">
    ...
    <div class="logo-after-login">
      ...
      <?php else: ?> 
        <a href="<?php echo e(url('/')); ?>"><img src="<?php echo e(url('/')); ?>/assets/buyer/images/chow-logo.png" alt="" /></a>
      <?php endif; ?> 
     ...
     <div class="afterlns-right">
        <div class="linewallet-head">
            ...
            <img src="<?php echo e(url('/')); ?>/assets/seller/images/wallet-icon-seller-pg.png" alt="">
          </div>
          <div class="price-wallet"><span>$</span><a  style="color: #0ea31c;" href="<?php echo e(url('/')); ?>/buyer/wallet"><?php echo e(isset($remain_wallet_amount) ? $remain_wallet_amount : ''); ?></a>
          </div>
        </div>
         <div class="dropdown-new hover-new">
           <?php if($login_user == true && $login_user->inRole('buyer') == true): ?>

               <?php $user_profile_image = get_user_image(); ?>
            ...
            <a href="#">
              ...
              <!-- <i class="fa fa-user-circle"></i> -->
                    ...
                    ?>
                       ...
                       <span class="nameuser-byrs"> <?php echo e(isset($user_name) ? $user_name : ''); ?> </span>
                        

             </a>
            <i class="fa fa-angle-down"></i>
            <ul>
                <li><a href="<?php echo e(url('/')); ?>/buyer/change_password">Change Password</a></li>
             ...
             <div class="notification">
                  ...
                  <div class="notification-menu">
                    ...
                    <div class="invite-p-drop">
                     ...
                     Gift a friend <?php echo e('$'.$buyer_refered_amount); ?> in Chowcash when you invite them to Chow and get <?php echo e('$'.$buyer_referal_amount); ?> in Chowcash credits when they make their first purchase.
        ...
        <div class="favoirt-main icon-favoirt-mains byer-icons-right">
            <div class="favoirt-main-li buyer-notification-icon">
                <a href="<?php echo e(url('/')); ?>/buyer/notifications"><span id="buyer_notify"><?php echo e($total_noti_cnt); ?></span> <img src="<?php echo e(url('/')); ?>/assets/buyer/images/chow-bell.svg" class="notification-head" alt=""></a>
            </div>
            
            <div class="favoirt-main-li">
                <?php if($login_user == true && $login_user->inRole('buyer')): ?>
                
                <a href="<?php echo e(url('/')); ?>/my_bag" id="mybag_div"><span><?php echo e(isset($cart_count) ? $cart_count : ''); ?></span> <img class="width-head-byr" src="<?php echo e(url('/')); ?>/assets/front/images/cart-icon-header.svg" alt="" /></a>
                <?php endif; ?>
            </div>
        </div> 
     </div>
              ...
              <span id="showiperr"></span>
                 <form id="modalform"> 
                    ...
                    <div class="form-group form-box">
                           ...
                           <?php if($login_user == true && $login_user->inRole('buyer') && $login_user->date_of_birth != ''): ?>
                            value="<?php echo e($login_user->date_of_birth); ?>" 
                           <?php endif; ?>
...
<!-------------------start of policies modal-------------------------->



<div id="mypoliciesdModal" class="modal fade modalauto">
    <div class="modal-dialog dialogauto-new">
        <div class="modal-content">          
            <div class="modal-body">
              
              <div class="subscribe-title-new">New Policies</div>
              <span id=""></span>
                 <form id="frm-policies"> 
                   <span id="status_msgs"></span>
                    <?php echo e(csrf_field()); ?>

                          
                          <?php if(isset($login_user) && $login_user->inRole("buyer")==true): ?>

                    
                           <div class="form-group form-box">
                              <div class="checkbox clearfix">
                                  <div class="form-check checkbox-theme rw-checkbox-theme-age-verification">
                                      <input class="form-check-input" type="checkbox" value=""  id="ageverfication" data-parsley-required="true" data-parsley-required-message="Please accept age verification term">
                           ...
                           <div class="form-group form-box">
                              <div class="checkbox clearfix">
                                  <div class="form-check checkbox-theme rw-checkbox-theme-age-verification">
                                      <input class="form-check-input" type="checkbox" value=""  id="terms" data-parsley-required="true" data-parsley-required-message="Please accept terms & conditions">
                                      <label class="form-check-label" for="terms"> By clicking this box, you represent that you have read and agree to our <u><b><a href="<?php echo e(url('/')); ?>/terms-conditions" class="mdl-alink" target="_blank">Terms and Conditions</b></u></a><span class="asteric_mark">.*</span></label>
                                  </div>
                              </div>
                           </div>
                           ...
                           <div class="form-group form-box">
                              <div class="checkbox clearfix">
                                  <div class="form-check checkbox-theme rw-checkbox-theme-age-verification">
                                      <input class="form-check-input" type="checkbox" value=""  id="privacyterms" data-parsley-required="true" data-parsley-required-message="Please accept privacy terms">
                                      <label class="form-check-label" for="privacyterms"> By clicking this box, you represent that you have read and agree to our <u><b><a href="<?php echo e(url('/')); ?>/privacy-policy" class="mdl-alink" target="_blank">Privacy Policy</b></u></a><span class="asteric_mark">.*</span></label>
                                  </div>
                              </div>
                           </div>
                        <?php elseif(isset($login_user) && $login_user==true && $login_user->inRole('seller')==true): ?>
                        <?php  $get_seller_questions = get_seller_questions();   ?>
                              
                               <?php if(isset($get_seller_questions) && $get_seller_questions >0): ?>
                               <?php $cnt=0; ?>
                                  <?php $__currentLoopData = $get_seller_questions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $questions): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                               <?php $cnt++; ?>

                                <input type="hidden" name="seller_question<?php echo e($cnt); ?>" id="seller_question<?php echo e($cnt); ?>" value="<?php echo $questions['question']; ?>">

                                <div class="form-group form-box">
                                  <div class="checkbox clearfix">
                                      <div class="form-check checkbox-theme">
                                          <input class="form-check-input seller_answer" type="checkbox" value="<?php echo $questions['question']; ?>" id="seller_answer<?php echo e($cnt); ?>" name="seller_answer<?php echo e($cnt); ?>" data-parsley-errors-container=".seller_answer_eror<?php echo e($cnt); ?>" data-parsley-required-message="Please agree to the above terms" data-parsley-required="true">
                                          <label class="form-check-label" for="seller_answer<?php echo e($cnt); ?>"> <?php echo $questions['question']; ?><span class="asteric_mark">*<span> </label>
                                            <div class"seller_answer_eror<?php echo e($cnt); ?>"></div>
                                      </div>
                                  </div>
                               </div>
                    ...
                    <div class="text-center">
                    <a href="#" class="btn-md btn-theme next-right btnsubscribe"  id="btn-change-policies" >Accept Policies</a>
                    </div>
...
<script>
  ...
  $(document).ready(function(){
     ...
     var showmodal = "<?php echo e($showmodal); ?>";
     var showpasswordmodal = "<?php echo e($showpasswordmodal); ?>";

     var show_policies_popup = "<?php echo e($show_policies_popup); ?>";

     if(show_policies_popup==1)
     {
         $("#mypoliciesdModal").modal('show');
     }else{
         $("#mypoliciesdModal").modal('hide');
     } 
...
//start function for change policies
$('#btn-change-policies').click(function() {

    if ($('#frm-policies').parsley().validate() == false) return;

    $.ajax({
        url: SITE_URL + '/update_policy_flag',
        data: new FormData($('#frm-policies')[0]),
        method: 'POST',
        contentType: false,
        processData: false,
        cache: false,
        ...
        beforeSend: function() {
            showProcessingOverlay();
            $('#btn-change-policies').prop('disabled', true);
            $('#btn-change-policies').html('Updating... <i class="fa fa-spinner fa-pulse fa-2x fa-fw"></i>');
        },
        success: function(response) {

            hideProcessingOverlay();
            $('#btn-change-policies').prop('disabled', false);
            $('#btn-change-policies').html('SAVE');
            ...
            if (typeof response == 'object') {
                if (response.status && response.status == "SUCCESS") {
                    ...
                    $('#status_msgs').html(response.message);
                    $('#status_msgs').css('color', 'green');
                    $('#status_msgs').css('fornt-size', '13px');
                    setTimeout(function(){
                      window.location.reload();
                    },2000);
                    //window.location.reload();
