...
<div class="container">
    <div class="our-mission-abts">
      <img src="<?php echo e(url('/')); ?>/uploads/<?php echo e($res_cms[0]->about_us_image); ?>" alt="Computer man" style="width:300px;height:300px;"> 
...
<div class="container">
    <div class="our-mission-abts">
    <div class="leftmission"> <img src="<?php echo e(url('/')); ?>/assets/front/images/chowicon.png" alt="About Us" /></div>
    <div class="rightmission">
      
        <h1><?php echo e(ucwords($res_cms[0]->meta_keyword)); ?></h1> 
...
<div class="about-floatleft-main">
    ...
    <div class="container">
        ...
        <div class="newsabotudtxt"><?php echo $res_cms[0]->page_desc; ?></div>
    </div>
    <div class="clearfix"></div>
</div>
 ...
 <!-- <div class="about-floatleft-main">
    <div class="about-floatleft-left">
        <img src="<?php echo e(url('/')); ?>/assets/front/images/press-about.jpg" alt="" />
    </div>
...
<!-- <div class="about-floatleft-main floatrights-abouts">
    ...
    <div class="about-floatleft-right">
       ...
       <div class="about-floatleft-left">
        <img src="<?php echo e(url('/')); ?>/assets/front/images/about-cultures.jpg" alt="" />
    </div>
    <div class="clearfix"></div>
</div> -->
...
<!-- <div class="about-floatleft-main">
    <div class="about-floatleft-left">
        <img src="<?php echo e(url('/')); ?>/assets/front/images/big-top-about.jpg" alt="" />
    </div>
    <div class="about-floatleft-right">
...
<!-- <div class="container">
    <div class="mapabouts">
        <img src="<?php echo e(url('/')); ?>/assets/front/images/maps-base.gif" alt="">
    </div>
</div> -->
...
<?php echo $__env->make('front.layout.master',['page_title'=>'About'], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>