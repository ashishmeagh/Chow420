                ...
                <div class="col-sm-md">
                    <div class=" footer-col-head">
                      ...
                      ?>
                        ...
                        <img src="<?php echo e(url('/')); ?>/assets/front/images/chowlogos-white.png"  alt="Logo" />

                        

                    </div>
                    <div class="copytxt-ftr">
                      <i class="fa fa-copyright"></i> 2018-2021 <a href="<?php echo e(url('/')); ?>">Chow420.com</a>
                    </div>
                 ...
                 $href='';
                 ?>
                 <?php if(!empty($cms_about_cbd_arr) && count($cms_about_cbd_arr)>0): ?>
                  <div class="col-sm-md abc">
                      ...
                      <div class="menu_name points-footer">
                          <ul>
                            <?php $__currentLoopData = $cms_about_cbd_arr; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cms_about_cbd_arrs): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              ...
                              ?>
                              <li><a href="<?php echo e($href); ?>" target="_blank"><?php echo e($cms_about_cbd_arrs->page_title); ?></a></li>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                              <li><a href="<?php echo e(url('/')); ?>/helpcenter" <?php if (Request::segment(1) == 'helpcenter') {echo 'class="terms-links active"';} else {echo 'class="terms-links"';}?> target="_blank">Help Center</a></li>
                          </ul>
                      </div>
                  </div>
                <?php endif; ?>
                              ...
                              <div class="menu_name points-footer">
                                  <ul>
                                     ...
                                     ?>
                                      ...
                                      <li><a href="<?php echo e($href); ?>" target="_blank"><?php echo e($cms_terms_privacy->page_title); ?></a></li>
                  ...
                  <div class="row">
                    ...
                    <div class="menu_name points-footer">
                        <ul>
                            ...
                            <?php if(!empty($cms_terms_referal_arr) && count($cms_terms_referal_arr)>0): ?>
                              <?php $__currentLoopData = $cms_terms_referal_arr; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cms_terms_referal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <?php
                              ...
                              <li><a href="<?php echo e($href); ?>" target="_blank"><?php echo e($cms_terms_referal->page_title); ?></a></li>
                    ...
                    <div class="menu_name points-footer">
                        <ul>
                            <li><a href="<?php echo e(url('/')); ?>/forum">Chow420 Forum</a></li>
                            <li><a href="<?php echo e(url('/')); ?>/chowwatch">Chow Watch</a></li>
                        </ul>
                    </div>
                    </div>
                  </div>
...
<script>
 var _learnq = _learnq || [];
 if ('<?php echo e($trackemail); ?>') {
   _learnq.push(['identify', {
       '$email' : '<?php echo e($trackemail); ?>'
     }]);
  }
</script> -->
