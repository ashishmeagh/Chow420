       ...
       <div class="bg-tra">
        <div class="err-cont">
            ...
            <form id="refer-form">
             ...
             <input type="hidden" name="referalcode" id="referalcode" value="<?php echo e(isset($referalcode) ? $referalcode : ''); ?>">

              <div class="text-center">
               <div class="logo-head"><a href="<?php echo e(url('/')); ?>"><img src="<?php echo e($sitelogo); ?>" alt=""></a></div>
                <div class="error_type thak-u"></div>
                <p> <?php echo e(isset($site_setting_arr['referal_text'])?$site_setting_arr['referal_text']:''); ?></p>
            ...
            success:function(response)
            {
              ...
              if(typeof response =='object')
              {
                if(response.status && response.status=="SUCCESS")
                {
                    ...
                    setTimeout(function(){
                    window.location.href = SITE_URL+'/refer?referalcode='+code+'';
                  },2000);
