...
class ForumPostController extends Controller
{
                                ...
                                )
    {
       ...
       // $this->module_url_path              = url(config('app.project.admin_panel_slug')."/productlist");
        ...
        $this->module_view_folder           = "buyer.forum_post";
    ...
    public function index()
    {
        ...
        if(!empty($user))
        {
          ...
          /* get seller detail */
            $obj_buyer = $this->BuyerModel->where('user_id',$buyer_id)->first();
        ...
        $this->arr_view_data['arr_buyer']  = $arr_buyer;        
    ...
    { 
        ...
        $json_result     = $json_result->editColumn('enc_id',function($data) use ($current_context)
                          ...
                          /*  ->editColumn('description',function($data) use ($current_context)
                            ...
                            {   
                                /*view*/
                                $view_href =  url('/').'/buyer/posts/view/'.base64_encode($data->id);
                                ...
                                /*edit*/
                                $edit_href =  url('/').'/buyer/posts/edit/'.base64_encode($data->id);
                                $build_edit_action = '<a href="'.$edit_href.'" class="eye-actn" title="Edit Post"> Edit
                                </a>';
                                
                                /*delete*/
                                $delete_href =  url('/').'/buyer/posts/delete/'.base64_encode($data->id);
        ...
        $obj_post = DB::table($post_details)->select(DB::raw( $post_details.'.*,'.
                        ...
                        "CONCAT(".$prefix_user_detail.".first_name,' ',"
                           ...
                           ->leftJoin($prefix_container_detail,$prefix_container_detail.'.id','=',$post_details.'.container_id')
                            ...
                            ->where($post_details.'.user_id',$buyer_id)
    ...
    public function create()
    {
        ...
        if(!empty($user))
        {
          $buyer_id = $user->id;
           ...
           /* get seller detail */
            $obj_buyer = $this->SellerModel->where('user_id',$buyer_id)->first();
   ...
   public function save(Request $request)
    {
        ...
        $form_data['user_id'] = $buyer_id;
        $form_data['user_type'] = 'Buyer';
