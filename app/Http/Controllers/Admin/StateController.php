            ...
            --------------------------------------------------------*/
               ...
               //save sub admin activity log 
                ...
                if(isset($user) && $user->inRole('sub_admin'))
                {
                    ...
                    $arr_event['message']      = $user->first_name.' '.$user->last_name.' has added state.';
        ...
        --------------------------------------------------------*/
           ...
           //save sub admin activity log 
            ...
            if(isset($user) && $user->inRole('sub_admin'))
            {
                ...
                $arr_event['title']        = $this->module_title;
                $arr_event['user_id']      = isset($user->id)?$user->id:'';
                $arr_event['message']      = $user->first_name.' '.$user->last_name.' has updated state.';
    ...
    {   
        ...
        {  
            ...
            if(isset($user) && $user->inRole('sub_admin'))
            {
                ...
                $arr_event['title']        = $this->module_title;
                $arr_event['user_id']      = isset($user->id)?$user->id:'';
                $arr_event['message']      = $user->first_name.' '.$user->last_name.' has activated state.';
    ...
    public function perform_deactivate($id)
    {
        ...
        if($deactivate)
        {
            ...
            if(isset($user) && $user->inRole('sub_admin'))
            {
                ...
                $arr_event['title']        = $this->module_title;
                $arr_event['user_id']      = isset($user->id)?$user->id:'';
                $arr_event['message']      = $user->first_name.' '.$user->last_name.' has deactivated state.';
            ...
            --------------------------------------------------------*/
               ...
               //save sub admin activity log 
                ...
                if(isset($user) && $user->inRole('sub_admin'))
                {
                    ...
                    $arr_event['title']        = $this->module_title;
                    $arr_event['user_id']      = isset($user->id)?$user->id:'';
                    $arr_event['message']      = $user->first_name.' '.$user->last_name.' has deleted state.';
