    ...
    */
    ...
    public function store(Request $request)
    {
        ...
        $arr_data = array(
        						...
        						'template_from_mail' 	=>	 'admin@afroin.com',
        						'template_from'			=>	 'ADMIN'
        				 );
            ...
            --------------------------------------------------------*/
               ...
               //save sub admin activity log 
                ...
                if(isset($user) && $user->inRole('sub_admin'))
                {
                    ...
                    $arr_event['message']      = $user->first_name.' '.$user->last_name.' has added email template.';
...
/*
        ...
        {*/
        	...
        	if($entity)
        	{
                ...
                --------------------------------------------------------*/
                   ...
                   //save sub admin activity log 
                    ...
                    if(isset($user) && $user->inRole('sub_admin'))
                    {
                        ...
                        $arr_event['title']        = $this->module_title;
                        $arr_event['user_id']      = isset($user->id)?$user->id:'';
                        $arr_event['message']      = $user->first_name.' '.$user->last_name.' has updated email template '.$template_name.'.';
        		...
        		Flash::success(ucfirst(strtolower($this->module_title)).' updated successfully');
        	}
        	else
        	{
