...
class SuggestionListController extends Controller
{
                                ...
                                UserService $UserService) 
    {
        ...
        $this->module_title       = "User Search";
        $this->module_view_folder = "admin.suggestion_list";
        $this->module_url_path    = $this->admin_url_path."/user_search";
    }
    ...
    public function get_records(Request $request)
    {
        ...
        $obj_search_suggestion_title_table = DB::table($search_suggestion_title_table)
                                                ->select(DB::raw(
                                                    ...
                                                    $prefixed_search_suggestion_title_table.'.front_suggession_title,'.
                                                    $prefixed_search_suggestion_title_table.'.suggession_link,'.
                                                    $prefixed_search_suggestion_title_table.'.title as user_search,'.
                                                    $prefixed_search_suggestion_title_table.'.if_user_search_contains as category'
        ...
        $json_result =   $json_result->editColumn('enc_id',function($data) use ($current_context)
                        ...
                        ->editColumn('user_search',function($data) use ($current_context)
                        {

                            $user_search = '';

                            $user_search = isset($data->user_search)?$data->user_search:'N/A';
                        ...
                        ->editColumn('category',function($data) use ($current_context)
                        {
                            ...
                            $category = isset($data->category)?$data->category:'N/A';
                        ...
                        ->editColumn('front_suggession_title',function($data) use ($current_context)
                        {

                            $front_suggession_title = '';

                            $front_suggession_title = isset($data->front_suggession_title)?$data->front_suggession_title:'N/A';


                            return $front_suggession_title;


                        })

                        ->editColumn('suggession_link',function($data) use ($current_context)
                        {

                            $suggession_link = '';

                            $suggession_link = isset($data->suggession_link)?$data->suggession_link:'N/A';


                            return $suggession_link;
    ...
    public function store(Request $request)
    {
        ...
        $search_suggestion_title_instance->front_suggession_title  =  isset($form_data['title'])?$form_data['title']:'';
     
        $search_suggestion_title_instance->suggession_link         =  isset($form_data['suggestion_url'])?$form_data['suggestion_url']:'';

        $search_suggestion_title_instance->if_user_search_contains  =  isset($form_data['search_category'])?$form_data['search_category']:'';
