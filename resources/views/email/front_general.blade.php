...
<html xmlns="http://www.w3.org/1999/xhtml">
   <head>
      ...
      <title>Email Template View : {{ config('app.project.name') }}</title>
   </head>
               ...
               <tr>
                  <td bgcolor="#FFFFFF" style="padding:15px; border:1px solid #e5e5e5;">
                     <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                           <td>
                              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                 <tr>
                                    <td>
                                       @if(isset($site_setting_arr['site_logo']))
                                       <a href="{{url('/')}}"><img style="width: 15%;" src="{{url('/')}}/uploads/profile_image/{{$site_setting_arr['site_logo']}}"  alt="logo" ></a>
                                       @endif
                                    </td>
                        ...
                        <tr>
                           <td style="text-align:center; color:#fff;background-color:#2a2a2a; padding-bottom:10px;"> Copyright {{ date("Y") }} by <a target="_blank" href="{{url('/')}}" style="text-align:center; color:#fff;">{{ strtolower(config('app.project.name')) }}</a> All Right Reserved.
                           </td>
                        </tr>
                     </table>
                  </td>
