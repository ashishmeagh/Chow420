    ...
    <section id="wrapper" class="error-page">
        <div class="error-box">
            <div class="error-body text-center">
               {{--  <h1>503</h1> --}}
                <h3 class="text-uppercase">WE WILL BE BACK SHORTLY</h3>
               {{--  <h3 class="text-uppercase">This site is getting a up in few minute.</h3>
                <p class="text-muted m-t-30 m-b-30">Please try after some time {{config('app.project.name')}} is currently under maintenance mode. Thank you for your patience. Stay Tuned!</p> --}}
                {{-- <a href="{{url('/')}}/admin/dashboard" class="btn btn-info btn-rounded waves-effect waves-light m-b-40">Back to home</a> --}} 
            </div>
            <footer class="footer text-center">{{date('Y')}} © {{config('app.project.name')}}</footer>
        </div>
    </section>
    <!-- jQuery -->
