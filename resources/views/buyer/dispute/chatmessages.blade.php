                        ...
                        <div class="right-message-block left-message-block ">
                           <div class="rights-message-profile"> <!------login user id is the sender id---------->
                           ...
                           <div class="left-message-content">
                              ...
                              <div class="actual-message">
                                 ...
                                 <a target="_blank" href="{{$attachment_img_public_path.$chat['attachment']}}"><img src="{{$attachment_img_public_path.$chat['attachment']}}" width="200px;" height="200px;"></a>
                                 @else
                                 {{$chat['message'] or ''}}
                                 @endif
                              </div>
                        ...
                        <div class="left-message-block">    <!------login user id is the receiver id---------->
