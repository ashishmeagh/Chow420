        ...
        {{--   <h4> <span id="showerr"></span> </h4> --}}
            ...
            <div class="col-md-12">
              ...
              <div class="col-md-12">
                  <div class="form-group">
                   ...
                   <textarea name="title" id="title" rows="4" cols="4" placeholder="Enter forum post title" data-parsley-required ='true' data-parsley-required-message="Please enter forum post title" >@php echo $arr_post['title'] @endphp
                   </textarea>
                    <script>
         ...
         {{--    <div class="col-md-12">
                 <div class="form-group">
                    ...
                    <textarea name="description" id="description" placeholder="Enter forum post description" data-parsley-required ='true' data-parsley-required-message="Please enter forum post description">{{ $arr_post['description'] }}</textarea>
                </div>
            </div>  --}}
