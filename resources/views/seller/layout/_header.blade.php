...
{{--     <title>{{isset($page_title)?$page_title:''}}  : {{ config('app.project.name') }}</title>
 --}}
    ...
    <!-- Bootstrap CSS -->
    <link href="{{ url('/') }}/assets/seller/css/bootstrap.css" rel="stylesheet" type="text/css" />
    <!--font-awesome-css-start-here-->
    <link href="{{ url('/') }}/assets/seller/css/font-awesome.min.css" rel="stylesheet" type="text/css" />
    <!--Custom Css-->
    <link href="{{ url('/') }}/assets/seller/css/chow.css" rel="stylesheet" type="text/css" />
    <link href="{{ url('/') }}/assets/seller/css/afterlogin-css.css" rel="stylesheet" type="text/css" />
   ...
   <link rel="stylesheet" type="text/css" href="{{ url('/') }}/assets/common/data-tables/latest/dataTables.bootstrap.min.css">
    ...
    <!--Main JS-->
    <script type="text/javascript" src="{{ url('/') }}/assets/seller/js/jquery-1.11.3.min.js"></script>
    <!--[if lt IE 9]>-->
...
<!-- End Google Tag Manager (noscript) -->
 ...
 <div class="header-afterlogin">
    ...
    <div class="logo-after-login">
        ...
        @else
         <a href="{{url('/')}}"> <img src="{{ url('/') }}/assets/seller/images/chow-logo.png" alt="" /></a>
        @endif
    </div>

    {{-- <div class="seatch-header-seller-main">
      <div class="seatch-header-seller-left">
        <input type="text" placeholder="Invite a seller, enter email!" />
        <a href="#" class="referseller-link-v">Refer Seller <span>$9785</span></a>
      </div>
    </div> --}}
    ...
    <div class="businessnamecls">
        @php
            ...
            @endphp
             ...
             <a href="{{ url('/') }}/search?sellers={{$business_name}}" target="_blank">
             {{ url('/') }}/search?sellers={{$business_name}}</a>
             @endif
             <a href="{{ url('/') }}/search?sellers={{$business_name}}" target="_blank" class="viewstorecls btn btn-default" style="background-color: #873dc8;color: #fff;border: 1px solid #873dc8;text-decoration: none;">View Store</a>
    </div>
     ...
     <div class="afterlns-right">
         ...
         <div class="dropdown-new hover-new">
            <a href="#"> 
               ...
               {{--  <span class="profl-em"><img src="{{ url('/') }}/assets/images/avatar.png" alt="" /></span> --}}
            ...
            <ul>
                <li><a href="{{ url('/') }}/seller/change_password">Change Password</a></li>
        ...
        <div class="favoirt-main notification-head-li">
              ...
              @if($user_subscribed_flag==1 && isset($user_subscriptiondata) && !empty($user_subscriptiondata) && $user_subscriptiondata[0]['membership']=="2")
             ...
             @endif 
                ...
                <div class="wallet-totl header-wallet">
                      <div class="icon-wallets">
                         <img src="{{url('/')}}/assets/seller/images/wallet-icon-slrs.png" alt="">
                      </div> 
                       @php
                    ...
                    @endphp
                      ...
                      <div class="price-wallet"><span>$ </span> {{  isset($showamt)?num_format($showamt):'00.00' }}</div>
                      <div class="clearfix"></div>
                </div>
                <!--------end of wallet------------->

              <div class="favoirt-main-li notificationicon-seller">
                <a href="{{ url('/') }}/seller/notifications"><span id="seller_notify">{{ $total_noti_cnt }}</span><img src="{{url('/')}}/assets/seller/images/notificationicon.png" class="notification-head" alt=""></a>
            </div>
