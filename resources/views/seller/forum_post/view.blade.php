...
{{--                 <div class="clearfix"></div>
 --}}            </div>
            ...
            <div class="order-id-main-left classordermain">
                ...
                <div class="ordr-id-nm">@php 
                   if($arr_post_data['title']) 
                    echo $arr_post_data['title'];
                   else
                     echo 'NA';  
                 @endphp
                </div>
          ...
          {{--   <div class="order-id-main-left classordermain">
             ...
             <div class="order-id-main-left classordermain">
                ...
                <div class="ordr-id-nm"> {{ date("M d Y H:i A",strtotime($arr_post_data['created_at'])) }} </div>
           ...
           @if(isset($arr_post_data['post_type']) && $arr_post_data['post_type']=="link")
            ...
            <div class="clearfix"></div>
             <a href="{{ url('/') }}/seller/posts" class="butn-def cancelbtnss pull-right">Back</a>
             <div class="clearfix"></div>
        </div> 
