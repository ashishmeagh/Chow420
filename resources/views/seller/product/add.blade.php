...
{{--         <div class="form-group row" id="div_for_cannabinoids" style="display:none">
                                      <label for="product_video_source" class="col-md-2 col-form-label"> </label>

                                      <div class="col-md-6" id="div_append_cannabinoids">
                                                @php 

                                                $row_cnt = 0;
                                                @endphp
                                                <div class="col-md-12" style="padding:10px;border: 1px solid #d1d1d1;">
                                                      <div class="col-md-6">
                                                            <select name="sel_cannabinoids[]" id="sel_cannabinoids{{$row_cnt}}" class="form-control sel_cannabinoids"  data-parsley-required-message="Please select cannabinoids">
                                                      ...
                                                      <div class="col-md-4">
                                                          <input type="text" name="txt_percent[]" id="txt_percent{{$row_cnt}}" class="form-control txt_percent" placeholder="%" data-parsley-trigger="keyup"     data-parsley-type="digits" min="0" max="100"  data-parsley-required-message="Please enter percent" >
                                                           <span style="color:red;" class="err_txt_percent" id="err_txt_percent_{{$row_cnt}}"></span>

                                                      </div>

                                                      <div class="col-md-2">
                                                        <img src="{{url('/')}}/assets/images/plus-icon - Copy.png" alt="Add New Cannabinoids" onclick="add_new_row({{$row_cnt}})" />
                                                      </div>
                                                </div>
                                       </div>
                                     <div class="col-md-4">
              ...
              <div class="form-group errorproduct-cannabinoid" id="div_append_cannabinoids">
                  ...
                  <div class="" style="padding:10px;border: 1px solid #d1d1d1;">
                        <div class="col-xs-5 col-sm-6 col-md-6 col-lg-6">
                               <div class="select-style">
                                    <select name="sel_cannabinoids[]" id="sel_cannabinoids{{$row_cnt}}" class="form-control sel_cannabinoids frm-select"  data-parsley-required-message="Please select cannabinoids" onchange="check_duplicate_cannabinoids(this.id,this.value,{{$row_cnt}})">
                                    <option value="">Select cannabinoids</option>                                
                                    @if(isset($cannabinoids_arr) && !empty($cannabinoids_arr))
                                      @foreach($cannabinoids_arr as $cannabinoids)
                                          <option value="{{ $cannabinoids['id'] }}">{{ $cannabinoids['name'] }}</option>
                        ...
                        <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                            <input type="text" name="txt_percent[]" id="txt_percent{{$row_cnt}}" class="form-control txt_percent" placeholder="%" min="0" max="100" 
            ...
            <div class="col-md-12">
              ...
              {{-- <div class="clone-divs">
                <input type="text" />
                <a href="#" class="btn-clone-minus"><i class="fa fa-minus"></i></a>
              </div> --}}
            </div> 
          ...
          <!--<div class="col-md-12">
            ...
            {{-- <div class="col-md-12">
                 <div class="slr-prdt-mn">
                     <div class="check-box form-group">
                         <input type="checkbox" class="css-checkbox is_age_limit" id="checkbox4" name="is_age_limit" value="1" />
                         <label class="css-label radGroup2" for="checkbox4">Age Limit</label>
                      </div>
            ...
            <div class="col-md-12">
                <div class="button-list-dts">
                    ...
                    {{-- <a href="{{ url('/') }}/seller/product/create" class="butn-def cancelbtnss">Cancel</a> --}}
                </div>
            </div>
       </div>
   </form>
...
{{-- <script type="text/javascript">
  function product_name_check(ref) {
    ...
    var produvt_name = ref.value;

    var is_cbd_exist = produvt_name.includes("cbd");
    var is_CBD_exist = produvt_name.includes("CBD");

    var is_thc_exist = produvt_name.includes("thc");
    var is_THC_exist = produvt_name.includes("THC");

    if (is_cbd_exist == true || is_CBD_exist == true || is_thc_exist == true | is_THC_exist == true ) {

      document.getElementById("product_name_error").innerHTML = "Remove the word 'CBD', if your products contain any form of cannabinoids, please identify it in your certificate of analysis of your product(s)";
