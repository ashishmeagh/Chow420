...
<div class="main-my-profile">
   ...
   <div class="innermain-my-profile add-product-inrs space-o">
     @if($arr_product['is_approve']=="2" && isset($arr_product['reason']) && ($arr_product['reason']!=""))
         <div class="order-id-main-left classordermain editproductstext-border"> 
          <span class="disapprovd-txt"><b>Disapproved Reason:</b></span> 
                <div class="productnames disapprove-reason" style="color:red"> 
                     ...
                     {{ $arr_product['reason'] }}  
                    {{-- @elseif($arr_product['is_approve']=="0" || $arr_product['is_approve']=="1" )
                     NA   
                    @else      
                    NA         --}}     
       ...
       <div class="row">
        {{--   <h4> <span id="showerr"></span> </h4> --}}
              ...
              <div class="col-md-12">
                  ...
                  <input type="hidden" name="prev_product_name" id="prev_product_name" value="{{ $arr_product['product_name'] }}">
              ...
              <div class="col-md-12">
                  ...
                  <input type="hidden" name="prev_sku" id="prev_sku" value="{{ $arr_product['sku'] }}">
             ...
             <div class="col-md-12">
                 <div class="form-group">
                    ...
                    <div id="brandList">
                     ...
                     <input type="hidden" name="prev_brand" id="prev_brand" value="{{ isset($brandname['name'])?$brandname['name']:'' }}">
            ...
            <div class="col-md-6">
                 <div class="form-group">
                    ...
                    <input type="hidden" name="prev_category" id="prev_category" value="{{ $arr_product['first_level_category_id'] or ''}}">
            ...
            <div class="col-md-6">
                 <div class="form-group">
                    ...
                    <div class="select-style">
                        ...
                        <input type="hidden" name="prev_sub_category" id="prev_sub_category" value="{{ $arr_product['second_level_category_id'] or ''}}">
            ...
            <div class="col-md-6">
              ...
              <input type="hidden" name="prev_price" id="prev_price" value="{{ num_format($arr_product['unit_price'],2) }}">
            ...
            <div class="col-md-6">
                ...
                <input type="hidden" name="prev_price_drop_to" id="prev_price_drop_to" value="{{ number_format($arr_product['price_drop_to'],2) }}" >
              ...
              <div class="form-group">
                <label class="" for= "shipping_type"> Shipping Type <span class="red">*</span></label>                   
                  <div class="radio-btns radiobuttoninline">
                    ...
                    <input type="hidden" name="prev_shipping_type" id="prev_shipping_type" value="{{$arr_product['shipping_type'] or ''}}">
            ...
            <div class="col-md-6" id="shipping_charges_block" @if($arr_product['shipping_type']=='1') style="display: block" @elseif($arr_product['shipping_type']=='0') style="display: none" @endif>
              <div class="form-group" >
                ...
                >
                <input type="hidden" name="prev_shipping_charges" id="prev_shipping_charges" value="{{ number_format($arr_product['shipping_charges'],2) }}">
            ...
            <div class="col-md-6">
                 <div class="form-group">
                    ...
                    <input type="hidden" name="prev_shipping_duration" id="prev_shipping_duration" value="{{isset($arr_product['shipping_duration'])?number_format($arr_product['shipping_duration'],1):'' }}">
            ...
            <div class="col-md-6">
                 <div class="form-group">
                   ...
                   {{--  <input type="number" name="product_stock" id="product_stock" class="input-text decimal" placeholder="Enter Total Quantity Available" data-parsley-required ='true' data-parsley-required-message="Please enter available quantity" data-parsley-min="1" value="{{ $arr_product['product_stock'] }}" min="1"> --}}
                    ...
                    <input type="hidden" name="prev_stock" id="prev_stock" value="{{ $remainingstock }}">
            ...
            <div class="col-md-6" id="concentration_div"  @if( (isset($db_cat_name) && $db_cat_name=="Essential Oils" || $db_cat_name=="Accessories") || (isset($db_spectrum_name) && $db_spectrum_name=="Hemp Seed") ) style="display: none" @else style="display: block" @endif>
                ...
                <input type="hidden" name="prev_quantity" id="prev_quantity" value="{{ $arr_product['per_product_quantity'] }}" >
             ...
             <div class="col-md-6">
                 <div class="form-group">
                    ...
                    <div class="select-style">
                        ...
                        <input type="hidden" name="prev_spectrum" id="prev_spectrum" value="{{ $arr_product['spectrum'] or '' }}">
...
@endphp
            ...
            <div class="col-md-12" id="div_for_cannabinoids" @if(!isset($product_cannabinoid)) style="display:none" @endif>
                ...
                @if(isset($product_cannabinoid) && count($product_cannabinoid) > 0)
                  ...
                  <input type="hidden" name="prev_sel_cannabinoids" id="prev_sel_cannabinoids" value="{{$prev_sel_cannabinoids or ''}}">
            ...
            @else
              ...
              <div class="col-xs-5 col-sm-6 col-md-6 col-lg-6">
                  ...
                  <div class="select-style">
                    <select name="sel_cannabinoids[]" id="sel_cannabinoids{{$row_cnt}}" class="form-control sel_cannabinoids"  data-parsley-required-message="Please select cannabinoids" data-parsley-trigger="change" >
                    <option value="">Select cannabinoids</option>                                
                    @if(isset($cannabinoids_arr) && !empty($cannabinoids_arr))
                      @foreach($cannabinoids_arr as $cannabinoids)
            ...
            <div class="col-md-12">
                ...
                <input type="hidden" name="prev_description" id="prev_description" value="{{$arr_product['description'] or ''}}">
            ...
            <div class="col-md-12">
                 <div class="form-group">
                  ...
                  <input type="hidden" name="prev_ingredients" id="prev_ingredients" value="{{$arr_product['ingredients'] or ''}}">
             ...
             <div class="col-md-12">
                 <div class="form-group">
                  ...
                  <input type="hidden" name="prev_suggested_use" id="prev_suggested_use" value="{{$arr_product['suggested_use'] or ''}}">
             ...
             <div class="col-md-12">
                 <div class="form-group">
                  ...
                  <input type="hidden" name="prev_amount_per_serving" id="prev_amount_per_serving" value="{{$arr_product['amount_per_serving'] or ''}}">
            ...
            <div class="col-md-12">
                <div class="form-group">
                  ...
                  <input type="hidden" name="prev_terpenes" id="prev_terpenes" value="{{$arr_product['terpenes'] or ''}}">
             ...
             <div class="col-md-12">
               <div  id="dynamic_field" class="form-group">
                 ...
                 <!----------------------------code for showing multiple images-------------> 
                  ...
                  <input type="hidden" name="prev_product_img" id="prev_product_img" value="{{$arr_product_image[0]['image'] or ''}}">
               ...
               <div  id="dynamic_field" class="form-group">
                  ...
                  <div class="clone-divs edt-chow-view">
                    ...
                    @if((isset($db_cat_name) && $db_cat_name=="Essential Oils" || $db_cat_name=="Accessories") || (isset($db_spectrum_name) && $db_spectrum_name=="Hemp Seed")) 
                     ...
                     <input type="hidden" name="prev_certificate_analysis" id="prev_certificate_analysis" value="{{$arr_product['product_certificate'] or ''}}">
          ...
          {{-- <hr>
            ...
            @if(isset($product_dimensions) && sizeof($product_dimensions)>0)
             ...
             @foreach($product_dimensions as $product_dimension)
                    ...
                    <div class="col-md-5">
                        <div class="form-group">
                           <label for="product_dimension_value">Product Dimension </label>
                           <input type="text" name="product_dimension_value[]"  class="input-text product_dimension_value" value="{{isset($product_dimension['option'])?$product_dimension['option']:''}}" id="product_dimension_value_{{$i}}" onkeyup="clear_err_dim_val({{$i}})">
          ...
          <!--------------end-product-dimension------------------------------->
           ...
           <div class="col-md-4">
             <div class="form-group">
                ...
                <input type="hidden" name="prev_drop_shipper_name" id="prev_drop_shipper_name"  value="{{isset($drop_shipper['name']) ?$drop_shipper['name']:'' }}">
          ...
          <div class="col-md-4">
             <div class="form-group">
                ...
                <input type="hidden" name="prev_drop_shipper_email" id="prev_drop_shipper_email" value="{{isset($drop_shipper['email']) ?$drop_shipper['email']:'' }}">
           ...
           <div class="col-md-4">
             <div class="form-group">
                ...
                {{-- <input type="text" name="drop_shipper_product_price" id="drop_shipper_product_price" class="input-text decimal readonly_div" placeholder="Enter Product Price" data-parsley-type="number" data-parsley-maxlength="10" data-parsley-min="1" value="{{isset($drop_shipper['product_price']) ?number_format($drop_shipper['product_price'],2):'' }}"  @if(isset($drop_shipper['email'])) readonly="readonly" @endif> --}}

                 <input type="text" name="drop_shipper_product_price" id="drop_shipper_product_price" class="input-text decimal" placeholder="Enter Dropshipper Price" data-parsley-type="number" data-parsley-maxlength="10" data-parsley-min="1" value="{{isset($drop_shipper['product_price']) ?number_format($drop_shipper['product_price'],2):'' }}">

                <input type="hidden" name="prev_drop_shipper_product_price" id="prev_drop_shipper_product_price" value="{{isset($drop_shipper['product_price']) ?number_format($drop_shipper['product_price'],2):'' }}">
             ...
             <div class="col-md-6">
                 <div class="form-group">
                    ...
                    <div class="select-style">
                        ...
                        <input type="hidden" name="prev_product_video_source" id="prev_product_video_source" value="{{$arr_product['product_video_source'] or ''}}">
            ...
            <div class="col-md-6 product_video_url_div" @if($arr_product['product_video_source']=='youtube' || $arr_product['product_video_source']=='vimeo') style="display: block" data-parsley-required ='true' @else style="display: none" @endif>
                 <div class="form-group">
                    ...
                    <div class="select-style">
                        ...
                        <input type="hidden" name="prev_product_video_url" id="prev_product_video_url" value="{{ $arr_product['product_video_url'] or ''}}">
     ...
     <!--        <div class="col-md-12">
               <div  id="dynamic_field" class="form-group">
                  ...
                  <input type="hidden" name="prev_additional_product_img" id="prev_additional_product_img" value="{{$arr_product['additional_product_image'] or ''}}">
                 ...
                 <div class="slr-prdt-mn">
                     <div class="check-box form-group">
                      ...
                      <div class="seller-age-ck">
                         ...
                         <span class="error-whitspace" id="age_restriction_err"></span>
                      </div>
                      <div class="clearfix"></div>
                 </div>
            </div>
