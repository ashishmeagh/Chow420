                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="title" id="title" value="{{$delivery_options['title']}}" class="input-text" placeholder="Enter title" data-parsley-required-message="Please enter title" data-parsley-required ='false' >
                                ...
                                <select class="frm-select" name="day" id="day" data-parsley-required ='true' data-parsley-required-message="Please select day">
                                    ...
                                    @php
                                        for ($x = 1; $x <= 31; $x++) {
                                            ...
                                            if ($delivery_options['day'] == $x ) {

                                                $option = "<option selected  value='".$x."'>".$x."</option>";
                                            }
                                            else {
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="cost" id="cost" value="{{$delivery_options['cost']}}" class="input-text" placeholder="Enter amount" data-parsley-required="true" data-parsley-required-message="Please enter cost" data-parsley-maxlength="10" data-parsley-min="1" data-parsley-type="number" min="0">
                            <input type="hidden" name="delivery_options_id"  value="{{$delivery_options['id']}}" >
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="button-list-dts">
                            <a href="javascript:void(0)" class="butn-def" id="btn_add">Update Delivery Options</a>
    ...
    $(document).ready(function() {
        ...
        $('#btn_add').click(function() {
            ...
            $.ajax({
                ...
                url: SITE_URL+'/seller/delivery_options/update',
                data: formdata,
                method:'POST',
                contentType: false,
                processData: false,
