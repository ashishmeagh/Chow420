      ...
      @if($user_subscribed=="1" && isset($user_subscriptiondata) && !empty($user_subscriptiondata) && isset($user_subscriptiondata[0]['membership']) && $user_subscriptiondata[0]['membership']=="2")
        ...
        <div class="my-order-buyr-main ord-my-blue earn-bx">
            ...
            <div class="content">
             ...
             {{--  <a href="{{ url('/')}}/refer?referalcode={{ $referalcode }}" class="add-cart" onclick="shareLink('#urlLink')"  target="_blank"> Invite</a> --}}
              <a href="{{ url('/')}}/refer?referalcode={{ $referalcode }}" class="add-cart" target="_blank"> Invite</a>
      ...
      <div class="col-xs-6 col-sm-6 col-md-4 col-lg-3 inx-iconsublime">
        {{--   <a href="{{ url('/') }}/seller/notifications"> --}}
            <div class="my-order-buyr-main ord-notification-tr">
              ...
              <div class="totl-cnts-nm" style="font-size: 31px">${{ $total_soldprice or 0}}</div>
       ...
       <div class="col-xs-6 col-sm-6 col-md-4 col-lg-3 inx-iconsublime">
         {{--  <a href="{{ url('/') }}/seller/notifications"> --}}
            <div class="my-order-buyr-main ord-notification-tr">
              ...
              <div class="totl-cnts-nm" style="font-size: 31px"> ${{ $total_productsum or 0}}</div>
