...
<div class="login-20 mainsignupnewclass membrsp-div-class">
        <div class="row">
          <div class="col-md-12">
              ...
              <div class="calcelled-membrship">
                @if(isset($get_cancelmembershipdata) && !empty($get_cancelmembershipdata['get_membership_details']))
                  ...
                  @if($get_cancelmembershipdata['is_cancel']=='1' && isset($get_cancelmembershipdata['current_period_enddate']))
          ...
          <a href="javascript:void(0)" id="cancel_subscription" class="pull-right btn btn-info">Cancel Subscription</a>
          @endif
                              ...
                              @foreach($arr_membership as $membership)
                                ...
                                <script type="text/javascript">
                                 ...
                                 @php 
                                    ...
                                    {
                                       if($m_price<$dbmembership_amount)
                                        $style ="display:none";
                                        else
                                        $style="display:block";    
                                    }
