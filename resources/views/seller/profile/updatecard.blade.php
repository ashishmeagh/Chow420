            ...
            <form id="nonce-form">
             ...
             <div class="col-xl-6 col-lg-6 col-md-6  bg-color-10">
                ...
                <div class="sub-plan-section seller-signup-phase3"  id="step3">
                      ...
                      <div class="form-section paymentdetails-frms1" id="paydetailform"  @if(!empty($get_membershipdata) && $user_subscribed=='1')  style="display:block" @else style="display:block" @endif>   
