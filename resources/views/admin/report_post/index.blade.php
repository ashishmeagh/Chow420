  ...
  <div class="modal-dialog" role="document">
    ...
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel" align="center">Message</h5>
...
<script type="text/javascript">
  ...
  $(document).ready(function()
  {
      ...
      'data': function(d)
        {
          ...
          d['column_filter[q_post_name]']  = $("input[name='q_post_name']").val()
      ...
      {data: 'user_name', "orderable": true, "searchable":false},
       {data: 'container', "orderable": true, "searchable":false},
    ...
    /*search box*/
     $("#table_module").find("thead").append(`<tr>
                    ...
                    <td></td>
                    <td><input type="text" name="q_post_name" id="q_post_name" placeholder="Search" class="search-block-new-table column_filter form-control" /></td>
                    <td>
