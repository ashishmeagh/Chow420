                            ...
                            <div class="row">
                                <div class="col-sm-12 col-xs-12">
                                  ...
                                  <div class="form-group row">
                                    ...
                                    <div class="col-md-10">                                       
                                       <input type="text" name="newsletter_name" id="newsletter_name" class="form-control" placeholder="Enter Newsletter Name" data-parsley-required ='true' data-parsley-required-message="Please enter newsletter name">
                                    </div>
                                  ...
                                  <div class="form-group row">
                                    <label class="col-md-2 col-form-label" for="product_name">Subject<i class="red">*</i></label>
                                    <div class="col-md-10">                                       
                                       <input type="text" name="newsletter_subject" id="newsletter_subject" class="form-control" placeholder="Enter newsletter subject" data-parsley-required ='true' data-parsley-required-message="Please enter newsletter subject">
                                    </div>
                                  ...
                                  <div class="form-group row">
                                    ...
                                    <div class="col-md-10">                                       
                                       <textarea name="newsletter_desc" id="newsletter_desc" class="form-control" placeholder="Enter Description"  >Hello ##USER_NAME##,</textarea>
                                       <script>
