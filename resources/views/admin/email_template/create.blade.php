            ...
            <div class="col-sm-12 col-xs-12">
               ...
               <div  class="tab-content">
                  <div class="form-group row">
                     <label class="col-xs-12 col-sm-4 col-md-3 col-lg-2 col-form-label" for="email"> Name <i class="red">*</i> </label>
                  ...
                  <div class="form-group row">
                     <label class="col-xs-12 col-sm-4 col-md-3 col-lg-2 col-form-label" for="email"> Variables 
                     <i class="red">*</i> 
                     </label>
                     <div class="col-xs-12 col-sm-8 col-md-9 col-lg-10">   
                  ...
                  <div class="form-group row">
                     <div class="col-xs-12 col-sm-8 col-md-9 col-lg-10">
                       <button type="submit" onclick="saveTinyMceContent();" class="btn btn-success waves-effect waves-light" value="Create">Create</button>
