           ...
           {!! Form::hidden('user_id',isset($arr_data['id']) ? $arr_data['id']: "")!!}
            ...
            <input type="hidden" name="post_code" id="post_code" class="clearField" value="{{$address_arr['post_code'] or ''}}">
             ...
             <div class="form-group row">
               ...
               <div class="form-group row">
                  ...
                  <div class="col-md-10">
                     <input type="text" class="form-control" name="last_name" placeholder="Enter Last Name" data-parsley-required="true" data-parsley-pattern="^[a-zA-Z]+$"  value="{{ $arr_data['last_name'] or ''}}" data-parsley-required-message="Please enter last name"/>
            ...
            <div class="form-group row">
              ...
              <div class="form-group row">
                  ...
                  <div class="col-md-10">
                     <input type="text" class="form-control" name="city" placeholder="City" id="city" id="locality" value="{{ $arr_data['city'] or '' }}" data-parsley-required="true" data-parsley-required-message="Please enter city"/>
            ...
            <div class="form-group row">
              ...
              <div class="form-group row">
               ...
               <div class="form-group row">
                  ...
                  <div class="col-md-10">
                     <input type="text" class="form-control" name="zipcode" id="postal_code" placeholder="Enter Zip Code" value="{{ $arr_data['zipcode'] or ''}}" data-parsley-required="true" data-parsley-required-message="Please enter zipcode" data-parsley-length="[1,6]" data-parsley-pattern="^[a-zA-Z0-9]+$" data-parsley-pattern-message="Only alphanumeric are allowed." />
