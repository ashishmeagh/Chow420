      ...
      <div class="container-fluid">
          <div class="row bg-title">
              <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                  <h4 class="page-title">{{$page_title or ''}} ({{$arr_category['product_type'] or ''}})</h4> </div>
          ...
          <div class="white-box">
                        @include('admin.layout._operation_status')
                         ...
                         <div class=" pull-right" >
                             ...
                             <a href="{{$module_url_path_parent or ''}}" class="btn btn-outline btn-info btn-circle show-tooltip btn-refresh" title="Back"><i class="fa fa-arrow-left"></i> </a> 
                           </div>
                           <br>
                           <br>
...
<div class="modal fade" id="question_sectionmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <input type="hidden" name="id" id="id" value="">

    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel" align="center">Question</h5>
...
<div class="modal fade" id="answer_sectionmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <input type="hidden" name="id" id="id" value="">

    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel" align="center">Answer</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
...
<script type="text/javascript">
  ...
  $(document).on('click','.readmorebtndecode',function(){
     var question = atob($(this).attr('question'));
     if(question)
     {
        $("#question_sectionmodal").modal('show');
  ...
  $(document).on('click','.readmorebtn',function(){
    ...
    $(document).on('click','.readmorebtnanswerdecode',function(){
     var answer = atob($(this).attr('answer'));
     if(answer)
     {
        $("#answer_sectionmodal").modal('show');
  ...
  $(document).on('click','.readmorebtnanswer',function(){
  ...
  $(document).ready(function()
  {
      ...
      {data: 'question', "orderable": true, "searchable":false},
      {data: 'answer', "orderable": true, "searchable":false},
  ...
  function statusChange(data)
   {
     ...
     swal({
          title: 'Do you really want to update status of this faq?',
          type: "warning",
