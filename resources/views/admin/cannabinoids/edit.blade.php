                        ...
                        @include('admin.layout._operation_status')
                            <div class="row">
                                <div class="col-sm-12 col-xs-12">
                                    ...
                                    <input type="hidden" name="id" id="id" value="{{ $arr_cannabinoids['id'] or '' }}" />


                                    <div class="form-group row">
                                    <label class="col-md-2 col-form-label" for="name">Name<i class="red">*</i></label>
                                    <div class="col-md-10">                                       
                                       <input type="text" name="name" id="name" class="form-control" placeholder="Enter Cannabinoid Name" value="{{isset($arr_cannabinoids['name'])?$arr_cannabinoids['name']:''}}" data-parsley-required="true" data-parsley-required-message="Please enter cannabinoid name"> 
                                    </div>
                                  ...
                                  <div class="form-group row">
                                    <label class="col-md-2 col-form-label">Is Active</label>
                                      <div class="col-sm-6 col-lg-8 controls">
                                         ...
                                         @if($arr_cannabinoids['is_active']=="0") value="0"
                                         @elseif($arr_cannabinoids['is_active']==1) value="1" 
                                         @endif data-size="small" class="js-switch " data-color="#99d683" data-secondary-color="#f96262" onchange="return toggle_status();"  @if($arr_cannabinoids['is_active'] =='1') checked="checked" @endif />
                                      </div>    
                                  </div>   
