          ...
          <div class="row bg-title">
              ...
              <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12"> 
                  <ol class="breadcrumb">
                    ...
                    <li class="active">Create Cannabinoids</li>
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-xs-12">
                                  ...
                                  <div class="form-group row">
                                    <label class="col-md-2 col-form-label" for="name">Cannabinoid Name<i class="red">*</i></label>
                                    <div class="col-md-10">                                       
                                       <input type="text" name="name" id="name" class="form-control" placeholder="Enter Cannabinoid Name" data-parsley-required="true" data-parsley-required-message="Please enter cannabinoid name">
                                    </div>
