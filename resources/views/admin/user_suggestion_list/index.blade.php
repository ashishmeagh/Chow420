...
$(document).ready(function()
{
    ...
    'data': function(d)
      {
        ...
        d['column_filter[q_search_suggestion_title]']  = $("input[name='q_search_suggestion_title']").val()
  ...
  /*search box*/
     $("#table_module").find("thead").append(`<tr>
                    <td></td>
                    <td><input type="text" id="q_search_suggestion_title" name="q_search_suggestion_title" placeholder="Search" class="search-block-new-table column_filter form-control" /></td>
                    <td>
