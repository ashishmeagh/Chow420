                            ...
                            <div class="row">
                                <div class="col-sm-12 col-xs-12">
                                  ...
                                  <div class="form-group row">
                                    ...
                                    <div class="col-md-10">                                       
                                       <textarea name="title" id="title" class="form-control" placeholder="Enter Title"  required></textarea>
                                       <script>
                                  ...
                                  <div class="form-group row">
                                      ...
                                      <div class="col-md-10">                                       
                                         <input type="color" name="title_color" id="title_color" class="form-control" placeholder="Select title color" required>
                                      </div>
                                       {{--  <span>{{ $errors->first('title') }}</span> --}}
                                    </div>   
                                    ...
                                    {{-- <div class="form-group row">
                                      ...
                                      <div class="col-md-10">                                       
                                         <input type="color" name="title_url_color" id="title_url_color" class="form-control" placeholder="Select URL color" required>
                                      </div>
                                    </div>    --}}
                                    ...
                                    <div class="col-md-10">                                       
                                       <input type="text" name="background_url" id="background_url" class="form-control" placeholder="Enter announcement background URL" 
                                        data-parsley-required="true"  data-parsley-type="url"  data-parsley-required-message="Background URL is required">
                                    </div>
                                    ...
                                    <div class="form-group row">
                                      ...
                                      <div class="col-md-10">                                       
                                         <input type="color" name="background_color" id="background_color" class="form-control" placeholder="Select background color" required>
                                      </div>
                                       {{--  <span>{{ $errors->first('title') }}</span> --}}
                                    </div> 
