                                ...
                                <div class="col-sm-12 col-xs-12">
                                  ...
                                  <div class="form-group row">
                                    ...
                                    <input type="file" name="image" id="image" class="dropify" {{-- data-max-file-size="2M" data-allowed-file-extensions="png jpg JPG jpeg JPEG" data-errors-position="outside" data-parsley-errors-container="#image_error" --}}
                                     data-default-file="{{$news_public_img_path}}/{{$arr_product_news['image'] or ''}}">
                                  ...
                                  <div class="form-group row">
                                    ...
                                    <div class="col-md-10">                                       
                                       ...
                                       value="{{isset($arr_product_news['video_url'])?$arr_product_news['video_url']:''}}" data-parsley-required="true" data-parsley-required-message="Video URL is required">
                                    </div>
                                   ...
                                   <div class="form-group row">
                                    ...
                                    <div class="col-md-10">                                       
                                       <input type="text" name="button_title" id="button_title" class="form-control" placeholder="Enter button title" value="{{isset($arr_product_news['button_title'])?$arr_product_news['button_title']:''}}"  data-parsley-required-message="Title is required"> 
                                    </div>
                                  </div>  
                                    ...
                                    <div class="col-md-10">                                       
                                       ...
                                       value="{{isset($arr_product_news['button_url'])?$arr_product_news['button_url']:''}}" data-parsley-required-message="Button url is required" >
                                    </div>
                                  </div>
