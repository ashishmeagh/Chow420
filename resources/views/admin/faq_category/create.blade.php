                            ...
                            <div class="row">
                                <div class="col-sm-12 col-xs-12">
                                  ...
                                  <div class="form-group row">
                                    ...
                                    <div class="col-md-10">                                       
                                      <input type="text" name="faq_category" id="faq_category" class="form-control" data-parsley-required-message="Please enter faq category" data-parsley-required="true">
                                    </div>
                                  </div>
