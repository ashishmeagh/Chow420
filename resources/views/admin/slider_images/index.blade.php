...
<script type="text/javascript">
  ...
  $(document).ready(function()
  {
      ...
      {data: 'slider_image', "orderable": true, "searchable":false},
      {data: 'slider_button', "orderable": true, "searchable":false},

      {data: 'image_url', "orderable": true, "searchable":false},
      {
        render : function(data, type, row, meta) 
        {
