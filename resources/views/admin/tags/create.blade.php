                            ...
                            <div class="row">
                                <div class="col-sm-12 col-xs-12">
                                  ...
                                  <div class="form-group row">
                                    ...
                                    <div class="col-md-10">                                       
                                       <input type="text" name="title" id="title" class="form-control" placeholder="Enter tag name" data-parsley-required="true" data-parsley-required-message="Please enter title">
                                    </div>
                                  ...
                                  <div class="form-group row">
                                    <label class="col-md-2 col-form-label" for="video_url"> Tag URL <i class="red">*</i></label>
                                    <div class="col-md-10">                                       
                                       <input type="text" name="link" id="link" class="form-control" placeholder="Enter tag url" data-parsley-required="true" data-parsley-required-message="Please enter tag url" data-parsley-type="url">
                                    </div>
                                  </div> 
