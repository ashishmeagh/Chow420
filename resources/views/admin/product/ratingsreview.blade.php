...
<div class="container-fluid">
   <div class="row bg-title">
      <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
         <h4 class="page-title">{{$module_title or ''}}  
         @if(isset($arr_data['product_name'])) of {{ $arr_data['product_name'] }}  @endif </h4>
      </div>
   ...
   <div class="col-sm-12"> 
      <div class="white-box">
         ...
         <div class="pull-right">           
           ...
           <a href="{{ url($module_url_path.'/addreview/'.base64_encode($productid)) }}" class="btn btn-outline btn-info btn-circle show-tooltip" title="Add Review"><i class="fa fa-plus"></i> </a> 
...
<script type="text/javascript"> 
   ...
   $(document).ready(function()
   {
     ...
     table_module = $('#table_module').DataTable({ 
      ...
      bFilter: false ,
      ajax: {
      'url':'{{ $module_url_path.'/get_reviews/'.$product_id}}',
      'data': function(d)
        {
