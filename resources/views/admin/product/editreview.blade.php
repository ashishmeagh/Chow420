                                ...
                                <div class="col-sm-12 col-xs-12">
                                    ...
                                    <div class="col-md-10">                                       
                                      <div class="ratings-frms rating-space-top">
                                           <div class="starrr text-left">
                                             <input name="rating" id="rating" class="star required" type="radio"  value="{{ isset($arr_product['rating'])?$arr_product['rating']:'1' }}"/>
                                          </div>
                                      </div>
                                    </div>
                                  ...
                                  <div class="form-group row">
                                    ...
                                    <div class="col-md-10">                                       
                                       ...
                                       @if(isset($arr_product['buyer_id']) && $arr_product['buyer_id']==0) data-parsley-required ='true' @else   @endif
                                       
                                       data-parsley-required-message="Please enter user name" value="{{ $arr_product['user_name'] or '' }}">
                                   ...
                                   <div class="form-group row">
                                    ...
                                    <div class="col-md-10">                                       
                                       <input type="text" name="title" id="title" class="form-control" placeholder="Enter Title" data-parsley-required ='true' data-parsley-required-message="Please enter title" value="{{ $arr_product['title'] or '' }}">
                                   ...
                                   <div class="form-group row">
                                    ...
                                    <div class="col-md-10">                                       
                                       <textarea name="review" id="review" class="form-control" placeholder="Enter Review" data-parsley-required ='true' data-parsley-required-message="Please enter review" >{{ $arr_product['review'] or '' }}
                                       </textarea>
                                        ...
                                        <li>
                                           <div class="checkbox clearfix">
                                              <div class="form-check checkbox-theme">
                                                  <input class="form-check-input" type="checkbox" value="anxiety.svg" id="rememberMe"  name="emoji[]" @if(isset($emjiarr) && !empty($emjiarr) && in_array("anxiety.svg", $emjiarr)) checked="checked" @endif>
                                         ...
                                         @if(isset($get_reported_effects) && !empty($get_reported_effects))
                                             @foreach($get_reported_effects as  $k=>$v)
                                              <li>
                                               <div class="checkbox clearfix">
                                                  <div class="form-check checkbox-theme">
                                                      <input class="form-check-input" type="checkbox" value="{{ $v['id'] }}" id="rememberMe2{{ $v['id'] }}"  name="emoji[]" @if(isset($emjiarr) && !empty($emjiarr) && in_array($v['id'], $emjiarr)) checked="checked" @endif>
                                                      <label class="form-check-label" for="rememberMe2{{ $v['id'] }}"  >
                                                        {{ $v['title'] or '' }}
