                            ...
                            <div class="row">
                                <div class="col-sm-12 col-xs-12">
                                                ...
                                                @foreach($product_cannabinoid as $key => $productCannabinoid)
                                                    <div class="col-md-12 flex-mobile" style="padding:10px;border: 1px solid #d1d1d1;" id="row_cannabinoids{{$row_cnt}}">
                                                          ...
                                                          <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                                                              <input type="text" name="txt_percent[]" id="txt_percent{{$row_cnt}}" class="form-control txt_percent" placeholder="%" value="{{$productCannabinoid['percent']}}" data-parsley-trigger="keyup"   {{--   data-parsley-type="digits" --}}
                                  ...
                                  {{--   <input type="file" name="product_image" id="product_image" class="dropify" data-default-file="{{$product_public_img_path}}{{$arr_product['product_image'] or ''}}"> --}}
                                    <input type="hidden" name="old_img" id="old_img" value="{{ isset(
                                      $arr_product_image[0]['image'])?$arr_product_image[0]['image']:
                                      '' }}">

                                    <input type="file" name="product_image" id="product_image"  data-max-file-size="2M" class="dropify" data-default-file=" @if(isset($arr_product_image[0]['image']))
                                    {{$product_public_img_path}}{{ $arr_product_image[0]['image'] }} 
                                    @else @endif">
              ...
              <!-------------end-product-dimension--------------------------->
                                ...
                                {{--   <input type="text" name="old_product_stock" value="{{ $arr_product['product_stock'] }}"> --}}
                                  ...
                                  <div class="form-group row">
                                    ...
                                    <div class="col-md-4">                                       
                                       <input type="email" name="drop_shipper_email" id="drop_shipper_email" class="form-control" placeholder="Enter DroppShipper Email" data-parsley-type="email" value="{{isset($drop_shipper['email']) ?$drop_shipper['email']:'' }}"  @if(isset($drop_shipper['email'])) readonly="readonly" @endif>
                                  ...
                                  <div class="form-group row product_video_url_div" id="product_video_url_div" @if($arr_product['product_video_source']=='youtube' || $arr_product['product_video_source']=='vimeo') style="display: block" data-parsley-required ='true' @else style="display: none" @endif>
                                   ...
                                   <div class="form-group row">
                                      ...
                                      <div class="col-md-10">
                                         <input type="text" name="product_rating" id="product_rating" class="form-control" placeholder="Enter Rating" value="{{ $arr_product['avg_rating'] or '' }}">
                                     </div>
                                  </div>
                                  ...
                                  <div class="form-group row">
                                      ...
                                      <div class="col-md-10">
                                        <input type="text" name="product_review" id="product_review" class="form-control"  placeholder="Enter Review" value="{{ $arr_product['avg_review'] or '' }}">
                                     </div>
                                  </div>
