                ...
                <div class="white-box">
                    ...
                    <!-- <div class="pull-left"> 
                      <div class="form-group row">
                        <label for="search_suggestion" class="col-sm-6 col-form-label">Search Suggestion</label>
                        <div class="col-sm-6 col-lg-6 controls">
                          <select name="search_suggestion" id="search_suggestion" class="form-control column_filter" onchange="filterData()">
                            <option value="" selected>All</option>
                              @if(isset($arr_search_suggestion) && sizeof($arr_search_suggestion) >0)
                                @foreach($arr_search_suggestion as $suggestion)
                                  <option 
                                    value="{{ isset($suggestion['id']) && $suggestion['id'] !='' ?$suggestion['id'] :'' }}">{{ isset($suggestion['title']) && $suggestion['title'] !='' ? $suggestion['title'] : '' }}
                                  </option>
                                @endforeach
                              @else
                                  No Records Found
...
$(document).ready(function()
{
    ...
    'data': function(d)
      {
        ...
        d['column_filter[q_search_suggestion_title]']  = $("input[name='q_suggestion_title']").val()
    ...
    {data: 'user_search', "orderable": true, "searchable":false},   
    {data: 'category', "orderable": true, "searchable":false},   
    {data: 'front_suggession_title', "orderable": true, "searchable":false},      
    {data: 'suggession_link', "orderable": true, "searchable":false},      
...
{
  var delete_param = "Search Suggestion";
