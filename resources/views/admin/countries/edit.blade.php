         ...
         <div  class="tab-content">
            ...
            <div class="tab-pane fade {{ $lang['locale']=='en'?'in active':'' }}" 
               ...
               <div class="form-group row">
                  ...
                  <div class="col-10">
                     @if($lang['locale'] == 'en')        
                     {!! Form::text('country_code',$arr_data['country_code'],['class'=>'form-control','data-rule-required'=>'true','placeholder'=>'Code']) !!}
                     @endif    
                  </div>
               ...
               <div class="form-group row">
                  ...
                  <div class="col-10">
                     ...
                     <input type="text" name="country_name_{{$lang['locale']}}" value="{{$arr_data['country_name']}}" class="form-control" data-parsley-required="true" placeholder="Name">
                     @else
                     {!! Form::text('country_name_'.$lang['locale'],$locale_title, ['class'=>'form-control','placeholder'=>'Name']) !!}
                     @endif    
                  </div>
