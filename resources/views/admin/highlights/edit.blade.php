        ...
        <div class="row bg-title">
            ...
            <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                <ol class="breadcrumb">
                    ...
                    <li class="active">Edit Highlight</li>
                </ol>
            </div>
        </div>
        <div class="row">
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-xs-12">
                            <form method="POST" class="form-horizontal" id="validation-form" onsubmit="return false;">
                                ...
                                <input type="hidden" name="id" id="id" value="{{ $arr_highlight['id'] or '' }}" /> 

                                <div class="form-group row">
                                    <label class="col-md-2 col-form-label" for="title" >Title <i class="red">*</i></label>
                                    <div class="col-md-10">
                                        <input type="text" name="title" id="title" class="form-control" placeholder=" Enter Title " data-parsley-required ='true' autocomplete="off" data-parsley-required-message="Please enter title" value="{{ isset($arr_highlight['title'])? $arr_highlight['title'] :'' }}"> 
                                        <div id="titleList">
                                        </div>
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-10">
                                        <textarea name="description" data-parsley-maxlength="100" id="description" class="form-control" placeholder="Enter Description" data-parsley-required ='true' data-parsley-required-message="Please enter description"   >{{ isset($arr_highlight['description'])? $arr_highlight['description'] :'' }}</textarea> 
                                    </div>
                                    <span>{{ $errors->first('description') }}</span>
                                </div>


                                <input type="hidden" name="old_img" id="old_img" value="{{ isset($arr_highlight['hilight_image'])?$arr_highlight['hilight_image']:'' }}">
                                    ...
                                    <div class="col-md-10">
                                        <div  id="dynamic_field">
                                            <div class="clone-divs none-margin">
                                                <input type="file" name="hilight_image" id="hilight_image"  data-max-file-size="2M" class="dropify"  data-allowed-file-extensions="png jpg JPG jpeg JPEG" data-errors-position="outside" data-parsley-errors-container="#image_error" 
                                                 @if(isset($arr_highlight['hilight_image'])) data-default-file="{{$highlight_public_img_path}}/{{ $arr_highlight['hilight_image'] }}" 
