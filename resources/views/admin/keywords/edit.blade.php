                ...
                @include('admin.layout._operation_status')
                    <div class="row">
                        <div class="col-sm-12 col-xs-12">
                            ...
                            <input type="hidden" name="id" id="id" value="{{ $arr_keyword['id'] or '' }}" />


                            <div class="form-group row">
                                <label class="col-md-2 col-form-label" for="title">Name<i class="red">*</i></label>
                                <div class="col-md-10">                                       
                                <input name="name" id="name" class="form-control" placeholder="Enter Name" data-parsley-required="true" data-parsley-required-message="Please enter name" value="{{isset($arr_keyword['keyword_name'])?$arr_keyword['keyword_name']:''}}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6 col-lg-8 controls">
                                    ...
                                    @if($arr_keyword['is_active']=="0") value="0"
                                    @elseif($arr_keyword['is_active']==1) value="1" 
                                    @endif data-size="small" class="js-switch " data-color="#99d683" data-secondary-color="#f96262" onchange="return toggle_status();"  @if($arr_keyword['is_active'] =='1') checked="checked" @endif />
                                </div>    
                            </div>   
