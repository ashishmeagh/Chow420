                            ...
                            <div class="row">
                                <div class="col-sm-12 col-xs-12">
                                  ...
                                  <div class="form-group row">
                                    <label class="col-md-2 col-form-label" for="newsletter_name"> Email<i class="red">*</i></label>
                                    <div class="col-md-10">                                       
                                       <input type="text" name="email" id="email" class="form-control" placeholder="Enter Email" value="{{ $arr_newsletter['email'] }}" data-parsley-required ='true' data-parsley-required-message="Please enter newsletter email" data-parsley-type="email" data-parsely-type-message="Please enter valid email address">
                                    </div>
