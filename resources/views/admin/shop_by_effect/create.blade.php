                            ...
                            <div class="row">
                                <div class="col-sm-12 col-xs-12">
                                  ...
                                  <div class="form-group row">
                                    ...
                                    <div class="col-md-10">                                       
                                       <input type="text" name="link_url" id="link_url" class="form-control" placeholder="Enter hyperlink url" data-parsley-type="url" data-parsley-required="true" data-parsley-required-message="Please enter hyperlink url">
                                    </div>
                                  </div> 
