                  ...
                  <thead>
                     <tr>
                        <th>
                           ...
                           <input id="date" name="q_date" onchange="filterData();" onkeypress="javascript:return false;" Placeholder="Select Date" value="" class="search-block-new-table column_filter form-control datepicker" size="10" type="text" >
                        </th>
                        <th>
...
<script type="text/javascript">
   ...
   $(document).ready(function()
   {
     table_module = $('#table_module').DataTable({ 
       ...
       'data': function(d)
         {
           d['column_filter[q_date]']        = $("select[name='q_date']").val()
