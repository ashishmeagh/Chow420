                        ...
                        @include('admin.layout._operation_status')
                            <div class="row">
                                <div class="col-sm-12 col-xs-12">
                                    ...
                                    {{ csrf_field() }}
                                    <input type="hidden" name="category_id" value="{{$enc_category_id}}">
                                   ...
                                   <div class="form-group row">
                                    <label class="col-md-2 col-form-label" for="desc">Description<i class="red">*</i></label>
                                    <div class="col-md-10">                                      
                                       <textarea rows="5" name="description" id="description"  class="form-control" data-parsley-required-message="Please enter description"></textarea>
                                    </div>
                                    <script>
