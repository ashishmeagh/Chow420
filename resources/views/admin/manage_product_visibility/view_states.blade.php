      ...
      <div class="col-sm-12">
          ...
          <div class="white-box">
                        @include('admin.layout._operation_status')
                         <form class="form-horizontal" id="frm_manage" method="POST" action="{{ url($module_url_path.'/multi_action_state') }}">
                          {{ csrf_field() }}


                         <div class=" pull-right" >
                            <a href="{{ url($module_url_path.'/create_state/'.$enc_id) }}" class="btn btn-outline btn-info btn-circle show-tooltip btn-refresh" title="Add More"><i class="fa fa-plus"></i> </a> 
...
<script type="text/javascript">
  ...
  $(document).ready(function()
  {
      ...
      bFilter: false ,
      ajax: {
      'url':'{{ $module_url_path.'/get_states/'.$enc_id}}',
      'data': function(d)
        {
