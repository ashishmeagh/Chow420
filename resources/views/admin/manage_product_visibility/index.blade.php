                         ...
                         <form class="form-horizontal" id="frm_manage" method="POST" action="{{ url($module_url_path.'/multi_action') }}">
                          {{ csrf_field() }}
                            <div class=" pull-right" >
                             <a href="{{ url($module_url_path.'/create') }}" class="btn btn-outline btn-info btn-circle show-tooltip btn-refresh" title="Add Country"><i class="fa fa-plus"></i> </a> 
...
<script type="text/javascript">
  ...
  $(document).ready(function()
  {
      ...
      bFilter: false ,
      ajax: {
      'url':'{{ $module_url_path.'/get_countries'}}',
      'data': function(d)
        {
