  ...
  <div class="col-md-12">
    <div class="box box-navi_blue">
      ...
      <div class="box-content">
        ...
        <div class="tabbable">
          {!! Form::open([ 'url' => $admin_panel_slug.'/categories/variety/store',
          'method'=>'POST',
          'enctype' =>'multipart/form-data',   
          'class'=>'form-horizontal', 
          'id'=>'validation-form' 
          ]) !!} 
          @foreach($get_parent_category as $sub_category_key => $value_sub_category)
          ...
          <div  class="tab-content">
            ...
            <div class="tab-pane fade {{ $lang['locale']=='en'?'in active':'' }}" 
              ...
              <div class="form-group">
                ...
                <!-- <div class="col-sm-6 col-lg-4 controls">
                  <select class="form-control" name="category_id" onchange='loadSubCategory(this);' data-rule-required="true"  >
                    ...
                    @if($value['id']==$value_sub_category['parent'])
                      selected="" 
              ...
              @endif
              <div class="form-group">
                <label class="col-sm-3 col-lg-2 control-label" for="state"> Title 
                  <i class="red">*
                  </i>
                </label>
                <div class="col-sm-6 col-lg-4 controls">
                  @if($lang['locale'] == 'en')        
                  {!! Form::text('title_'.$lang['locale'],old('title_'.$lang['locale']),['class'=>'form-control','data-rule-required'=>'true','data-rule-maxlength'=>'255']) !!}
                  @else
                  {!! Form::text('title_'.$lang['locale'],old('title_'.$lang['locale'])) !!}
                  @endif    
                </div>
                <span class='help-block'>{{ $errors->first('title_'.$lang['locale']) }}
                </span>  
              </div>
            </div>
            @endforeach
