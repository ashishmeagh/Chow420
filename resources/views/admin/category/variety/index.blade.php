...
<script type="text/javascript" src="{{ url('/') }}/assets/admin/data-tables/latest/jquery.dataTables.min.js">
</script>
<script type="text/javascript" src="{{ url('/') }}/assets/admin/data-tables/latest/dataTables.bootstrap.min.js">
</script>
@stop                    
