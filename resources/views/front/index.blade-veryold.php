        ...
        @if(!empty($arr_slider_images) && count($arr_slider_images)>0)
           @foreach($arr_slider_images as $slider) 
                ...
                <div class="{{ $active }}" style="background: url({{url('/')}}/uploads/slider_images/{{ $slide['slider_image']  }}) no-repeat ;background-position: center center; -webkit-background-size: 100% 100%;
                    -moz-background-size: 100% 100%; -o-background-size: 100% 100%; background-size: 100% 100%; margin: 0px;padding: 0; cursor: pointer">
                               ...
                               <div class="modarn-hm">{{ isset($slide['title'])?$slide['title']:''}}</div>
                                    ...
                                    <div class="button-rev homts">
                                      @if(isset($slide['slider_button']) && (!empty($slide['slider_button'])))
                                        <a target="_blank" href="{{ $slide['image_url'] }}" class="butn-def">{{ $slide['slider_button'] }}</a>
                                     @endif
                               </div>
                                </div>
                            </div>
...
<div class="top-rated-brands-main homepagenewlistings trending-products-cls-home">
 ...
 @if(isset($arr_trending) && count($arr_trending)>0)
        <div class="toprtd non-mgts viewall-btns-idx">Trending Products 

          @php
          if(isset($arr_trending) && count($arr_trending)<=$device_count)
        ...
        <div class="featuredbrands-flex">         
          <ul @if(isset($arr_trending) && count($arr_trending)<=$device_count)    
             class="f-cat-below7"      
           ...
           @elseif(isset($arr_trending) && count($arr_trending)>$device_count  && $isMobileDevice==0 )
              id="flexiselDemo2"    
           @endif --}}
            @elseif(isset($arr_trending) && count($arr_trending)>$device_count)
              id="flexiselDemo2"    
           @endif
         >
            ...
            @foreach($arr_trending as $trend_product)
             ...
             <li>
                <div class="top-rated-brands-list">
                   ...
                   <a href="{{url('/')}}/search/product_detail/{{isset($trend_product->id)?base64_encode($trend_product->id):'0'}}/{{ $product_title_slug }}" title="{{ ucfirst($trend_product->product_name) }}">
                      <div class="img-rated-brands">
                          <div class="thumbnailss"> 
                        ...
                        <div class="content-brands">
                             ...
                             <div class="titlebrds by-ttlbrn"> <span>{{ isset($trend_product->brandname)? ucwords($trend_product->brandname):''  }}</span></div> 
                            ...
                            <div class="starthomlist "  @if($avg_rating>0) title="{{$avg_rating}} Avg. rating"
                              ...
                              @if($avg_rating>0 && isset($rating))
                                <img src="{{url('/')}}/assets/front/images/star-rate-{{$rating}}.png" alt=""  title="{{$avg_rating}} Avg. rating"/>
...
<!-------------start of top rated products----------------------------------->
 ...
 @if(isset($arr_product) && count($arr_product)>0)
        <div class="toprtd non-mgts viewall-btns-idx">Top Rated Products 
          ...
          @php
          if(isset($arr_product) && count($arr_product)<=$device_count)
          $class = 'butn-def viewall-product';
          else
          $class = 'butn-def';  
          @endphp
        ...
        <div class="featuredbrands-flex tprtd-procudt">         
          <ul @if(isset($arr_product) && count($arr_product)<=$device_count)    
             class="f-cat-below7"      
          ...
          {{--  @elseif(isset($arr_product) && count($arr_product)>$device_count && $isMobileDevice==0)
              id="flexiselDemo1"
           @endif --}}
            @elseif(isset($arr_product) && count($arr_product)>$device_count)
              id="flexiselDemo1"
           @endif
         >
             ...
             <li>
                <div class="top-rated-brands-list">
                   @php
                      ...
                      $product_title_slug = str_slug($product_title);
                    @endphp
                    <a href="{{url('/')}}/search/product_detail/{{isset($product->id)?base64_encode($product->id):'0'}}/{{ $product_title_slug }}"  title="{{ ucfirst($product->product_name) }}"><div class="img-rated-brands">
                    <div class="thumbnailss">
                        ...
                        <div class="content-brands">
                            {{-- <div class="price-listing pricestatick"> <del class="pricevies">$18.91</del><span>$18.91 </span></div> --}}
                              ...
                              <div class="titlebrds by-ttlbrn"><span>{{ isset($product->brandname)? ucwords($product->brandname):''  }}</span></div>  
              ...
              <div class="cborder-home-product">
                  <div class="main-selectslist non-paddingd">
                    <div class="toprtd viewall-btns-idx smallfonts allproducttextright most-recent-padn"> 
                      ...
                      <a href="{{ url('/') }}/search" class="butn-def seeallproducts ">See All Products</a>
                      <div class="clearfix"></div>
                    </div>
                <div class="clearfix"></div>
                                              ...
                                              @elseif($login_user->inRole('buyer') == true)
                                                ...
                                                @else
                                                   {{--  <a href="javascript::void(0)"><div class="add_to_cart guest_url_btn"> Add to cart </div></a> --}}
                                                    ...
                                                    <a href="javascript::void(0)"><div class="add_to_cart" onclick="return buyer_redirect_login()"> Add to cart </div></a>
