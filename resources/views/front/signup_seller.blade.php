...
{{--     <meta name="title" content="Sell your products on one of the best marketplaces for CBD">
 --}}
  ...
  {{--   <meta name="description" content="Launch your online CBD dispensary or store in seconds. Get all the help you need for your online business. White labelling service, age-verification." /> --}}

    <meta name="description" content="Automate your compliance and more with Chow. Run your CBD business the right way!" /> 
...
{{--     <title>{{isset($page_title)?$page_title:""}} : {{ config('app.project.name') }}</title>
 --}}
    <title>Sell your products on one of the best marketplaces for CBD</title> 
...
.login-20 .login-inner-form.checkbxset .form-check label::before{top: 15px;}
input[type=radio] {
    margin-right: 3px;
     visibility: visible;
}
...
<div class="login-20 mainsignupnewclass">
    <div class="container">
        ...
        <div class="hidden-overflow" id="sethiddenoverflowclass">
            ...
            <form id="nonce-form" class="rw-signup-form-main">
                {{ csrf_field() }}
                <input type="hidden" name="role" id="role" value="seller">
                <input type="hidden" name="domain_source" id="domain_source" value="{{isset($domain_source)?$domain_source:''}}">




                <input type="hidden" name="refered_email" id="refered_email" value="{{ $refered_email }}">
                <input type="hidden" name="referal_code" id="referal_code" value="{{ $referal_code }}">

              <div class="col-xl-6 col-lg-6 col-md-6 bg-img rw-signup" {{-- style="background: rgba(0, 0, 0, 0.04) url({{ url('/') }}/images/seller-page-singup.jpg) top left repeat;"  --}}id="chw-logo">
                <div class="info">
                    <div class="logo-seller-lgns">
                        <a href="{{ url('/') }}"><img src="{{ url('/') }}/assets/front/images/chowlogos-white.png" alt="Logo" /></a>
                    </div>
                    {{--  <div class="sell-chow-signup">Grow your CBD business seamlessly</div> --}}
                     <!--  <div class="sell-chow-signup">Join Chow's CBD Market</div> -->
                      <div class="sell-chow-signup">The compliant way to sell CBD online</div>
                     <ul class="list-sellersignupleft">
                         <li><img src="{{ url('/') }}/assets/front/images/check-sellers-icn-whites.png" alt="Automate compliance with state laws and regulations" />Automate compliance with state laws and regulations</li>
                         <li><img src="{{ url('/') }}/assets/front/images/check-sellers-icn-whites.png" alt="Age-verify your customers seamlessly" />Age-verify your customers seamlessly</li>
                         {{-- <li><img src="{{ url('/') }}/assets/front/images/check-sellers-icn-whites.png" alt="" /> Command traffic to your store. Let us do the marketing for you!</li> --}}
                          <li><img src="{{ url('/') }}/assets/front/images/check-sellers-icn-whites.png" alt="Reduce the cost of operating your CBD business" />Reduce the cost of operating your CBD business</li>
                        {{--  <li><img src="{{ url('/') }}/assets/front/images/check-sellers-icn-whites.png" alt="" /> Operate and own a Chow automated dispensary </li> --}}

                         <li><img src="{{ url('/') }}/assets/front/images/check-sellers-icn-whites.png" alt="Take advantage of the traffic to Chow for your CBD store" />Take advantage of the traffic to Chow for your CBD store</li>
                     </ul>
                    
                </div>
                {{-- <div class="watermark">
                  <img src="{{ url('/') }}/assets/front/images/chowlogos-white.png" alt="" />
                </div> --}}
            </div>
            ...
            <div class="col-xl-6 col-lg-6 col-md-6  bg-color-10">
                ...
                <div class="form-section seller-signup-phase1" style="display: block;" id="step1">
                    ...
                    <h1><b>Create Dispensary Account</b></h1>
                    <div class="login-inner-form checkbxset">
                        {{-- <form id="signup-form">
                            {{ csrf_field() }} --}} 

                              <div class="form-group form-box">
                                 
                                  <input type="text" class="input-text" placeholder="Business Name" name="business_name" id="business_name" data-parsley-whitespace="trim" data-parsley-required="true"  {{-- data-parsley-pattern="^[a-zA-Z\s]+$" --}} data-parsley-required-message="Please enter business name" data-parsley-pattern="/^([A-Za-z0-9]+ )+[A-Za-z0-9]+$|^[A-Za-z0-9]+$/" data-parsley-pattern-message="Please remove special characters from business name"/>

                                  <div class="error"></div>
                                  <div id="business_exist_error_message"></div>
                                  <div class="clearfix"></div>
                              </div>
                            ...
                            <div class="form-group form-box">
                              <input type="text" class="input-text" placeholder="Email Address" name="email" id="email"
                                data-parsley-required="true" data-parsley-type-message="Please enter valid email address" value="{{$email or ''}}" 
                ...
                <div class="form-section seller-signup-phase2" style="display: none;" id="step2">
                    ...
                    <h3>Create Dispensary Account</h3>
                    <div class="login-inner-form checkbxset">
                ...
                <div class="sub-plan-section seller-signup-phase3" style="display: none;" id="step3">
                    ...
                    <div class="radio-sections">
                          ...
                          @if(isset($arr_membership) && !empty($arr_membership))  
                             ...
                             @endphp
                              @foreach($arr_membership as $membership)
                                 ...
                                 <div class="radio-btn" @if(isset($referal_code) && !empty($referal_code) && isset($refered_email) && !empty($refered_email) && $membership['membership_type']=="1") style="display: none;"@else style="display: block"@endif >
                                    <input type="radio" id="membership_{{ $membership['id'] }}" name="membership" amt="{{ $membership['price'] }}" 
                                    membership_type="{{ $membership['membership_type'] }}"  stripe_plan_id="{{ $membership['plan_id'] }}"  class="membership"  value="{{ $membership['id'] }}"  @if($i==0)  checked="checked" @endif />
                      ...
                      <!-------start of payment detail form---------------->
                       <div class="form-section paymentdetails-frms" id="paydetailform" @if($default_memtype==2) style="display:block" @else style="display:none" @endif>
                        ...
                        if(response.status && response.status=="SUCCESS")
                        {
                           ...
                           // window.location.href = SITE_URL+'/login/2/'+btoa(email);
                            ...
                            if(response.password_msg!=""){
                             ...
                             if(response.businessmsg!=""){
                                  $('#business_exist_error_message').css('color','red').html(response.businessmsg);
                              }else{
                                  $('#business_exist_error_message').html('');
                              }  
                             if(response.cardmsg!=""){
...
<script type="text/javascript">
    ...
    $('#btn-next').click(function(){
        ...
        /*------------------------------------------------*/
          ...
          if($('#business_exist_error_message').html() != "")
          { 
          ...
          if($('#user_exist_error_message').html() != "")
          {
              document.getElementById("btn-next").style.pointerEvents="none";
              $("#btn-next").css('background-color','#7d36bb99');
              $(".wrapper").css('cursor','not-allowed');
...
<script type="text/javascript">
  ...
  $("#business_name").change(function(){
    ...
    var pettern = /^([A-Za-z0-9]+ )+[A-Za-z0-9]+$|^[A-Za-z0-9]+$/;
         
        if(business_name.trim()=="")
        { 
            //$('#business_exist_error_message').css('color','red').html('Please enter business name');
        ...
        else if(!pettern.test(business_name))
        {
         
              $('#business_exist_error_message').css('color','red').html('Please remove special characters from business name');
                        ...
                        {    
                              ...
                              if(typeof response =='object')
                              {
                                  if(response.status && response.status=="SUCCESS")
                                  {
                                    ...
                                    $('#business_exist_error_message').css('color','red').html(response.msg);
                                    document.getElementById("btn-next").style.pointerEvents="none";
                                    $("#btn-next").css('background-color','#7d36bb99');
                                    $(".wrapper").css('cursor','not-allowed');
