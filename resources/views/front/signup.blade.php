      ...
      <div class="row">
        <div class="hidden-overflow">
           ...
           {{--  <div class="col-xl-6 col-lg-6 col-md-6 bg-img " style="background: rgba(0, 0, 0, 0.04) url(images/bg-image-14.jpg) top left repeat;">
                <div class="info">
                     <div class="sell-chow-signup">Why Buy on Chow?</div>
              ...
              <div class="col-xl-6 col-lg-6 col-md-6 bg-img rw-signup rw-buyer-signup" {{-- style="background: rgba(0, 0, 0, 0.04) url({{ url('/') }}/images/seller-page-singup.jpg) top left repeat;" --}}>
                <div class="info">
                    <div class="logo-seller-lgns">
                     ...
                     <ul class="list-sellersignupleft">
                         <li><img src="{{ url('/') }}/assets/front/images/check-sellers-icn-whites.png" alt="Trust the CBD products you buy" /> Trust the CBD products you buy</li>
                         <li><img src="{{ url('/') }}/assets/front/images/check-sellers-icn-whites.png" alt="Comply with your state CBD laws" /> Comply with your state CBD laws</li>
                         <li><img src="{{ url('/') }}/assets/front/images/check-sellers-icn-whites.png" alt="Review the certificate of analysis of products" /> Review the certificate of analysis of products</li>
                         <li><img src="{{ url('/') }}/assets/front/images/check-sellers-icn-whites.png" alt="Interact with retailers and ask questions" /> Interact with retailers and ask questions</li>
                         <li><img src="{{ url('/') }}/assets/front/images/check-sellers-icn-whites.png" alt="Share and review products you’ve purchased" /> Share and review products you’ve purchased</li>
                     </ul>
                </div>
                {{-- <div class="watermark">
                    ...
                    <div class="login-inner-form">
                       <div id="status_msg"></div>
                        ...
                        @if(Session::has('message'))
                            ...
                            <p class="alert {{ Session::get('alert-class', 'alert-warning') }}" id ="alert_container">
                                <a href="javascript:void(0)">
                                    <i class="fa fa-times" aria-hidden="true" class="close" data-dismiss="alert" aria-label="close"></i>
                                </a>{!! Session::get('message') !!}
                            </p>
                          ...
                          <input type="hidden" name="referal_code" id="referal_code" value="{{ $referal_code }}">
                           ...
                           <input type="hidden" name="hidden_productid" id="hidden_productid" value="{{$productid }}">
                            ...
                            <div class="form-group form-box">
                                <input type="email" name="email" id="email" class="input-text" placeholder="Email Address" data-parsley-required="true" data-parsley-type="email" data-parsley-type-message="Please enter valid email address" value="{{$email or ''}}" data-parsley-required-message="Please enter email"/>
                            ...
                            <div class="row">
                              ...
                              <div class="col-md-6">
                                <div class="form-group form-box">
                                  {{--  
                                  <textarea name="hear_about" rows="4" cols="50" id="hear_about" class="input-text form-control" placeholder="How did you hear about us" data-parsley-required="true" value="{{$hear_about or ''}}" data-parsley-required-message="Please enter how did you hear about us"></textarea>
                                  --}}
                                  <div class="select-style">
                           ...
                           <!--  <div class="form-group form-box">
                              <div class="checkbox clearfix">
                                  <div class="form-check checkbox-theme">
                                      ...
                                      <label class="form-check-label" for="rememberMe"> I Accept <a href="{{$terms_condition_url}}" target="_blank"> Terms and Conditions <span class="asteric_mark">*</span></a></label>
                                  </div>
                              </div>
                           </div>
                           ...
                           <div class="form-group form-box">
                              <div class="checkbox clearfix">
                                  <div class="form-check checkbox-theme rw-checkbox-theme-age-verification">
                                      ...
                                      <label class="form-check-label" for="terms"> By clicking this box, you represent that you have read and agree to our <u><b><a href="{{ url('/') }}/terms-conditions" class="pull-left" target="_blank">Terms and Conditions</b></u></a><span class="asteric_mark">.*</span></label>
                                  </div>
                              </div>
                           </div>
                           ...
                           <div class="form-group form-box">
                              <div class="checkbox clearfix">
                                  <div class="form-check checkbox-theme rw-checkbox-theme-age-verification">
                                      ...
                                      <label class="form-check-label" for="privacyterms"> By clicking this box, you represent that you have read and agree to our <u><b><a href="{{ url('/') }}/privacy-policy" class="pull-left" target="_blank">Privacy Policy</b></u></a><span class="asteric_mark">.*</span></label>
                                  </div>
                              </div>
                           </div>

                            <div class="buttonsection-bottom">
                                <a href="{{ url('/') }}" class="btn-md btn-theme backbtn-prv">Back</a>
              ...
              if(typeof response =='object')
              {
                if(response.status && response.status=="SUCCESS")
                {
                    ...
                    success_HTML +='<div class="alert alert-success alert-dismissible">\
                        <button type="button" class="close" data-dismiss="alert" aria-label="Close" data-close>\
