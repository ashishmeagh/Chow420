 ...
 <div class="banner-404" style="">
       <div class="bg-tra">
        <div class="err-cont">
         ...
         {{--     <input type="hidden" name="hiddenactivationcode" id="hiddenactivationcode" value="{{ $activationcode or '' }}"> --}}

            {{--   <input type="hidden" name="email" id="email" value="{{ $email or '' }}"> 
              <input type="hidden" name="user_type" id="user_type" value="{{ $user_type or '' }}"> --}} 
