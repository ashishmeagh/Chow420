                      ...
                      <div class="img-rated-brands">
                          ...
                          <div  @if(isset($isblur) && $isblur==1) class="thumbnailss blurclass" @else class="thumbnailss" @endif> 
                             ...
                             <!---------End out of stock on blur product-------------->
                               ...
                               {{--  <img data-src="{{url('/')}}/uploads/product_images/{{ $trend_product['product_images_details'][0]['image']}}" src="{{url('/assets/images/Pulse-1s-200px.svg')}}" class="portrait lozad" alt="{{ $product_title }}" /> --}}

                                <img data-src="{{$product_you_may_like_product_image}}" src="{{url('/assets/images/Pulse-1s-200px.svg')}}" class="portrait lozad" alt="{{ $product_title }}" />

                                @else
                                  <img data-src="{{url('/assets/images/default-product-image.png')}}" src="{{url('/assets/images/Pulse-1s-200px.svg')}}" class="portrait lozad" alt="{{ $product_title }}" />
                          ...
                          @php                                
                           ...
                           @endif>
                              @if($avg_rating>0 && isset($rating))
                                ...
                                <img src="{{url('/')}}/assets/front/images/star/{{$rating}}.svg" alt="{{$rating}}.svg" title="{{ isset($avg_rating)?$avg_rating:'' }} Rating is a combination of all ratings on chow in addition to ratings on vendor site."/> 
