            ...
            <div class="footer-col-block">
                ...
                <div class="col-sm-md col-more-md abc">
                  <div class="row">
                    ...
                    *These statement not have been evaluated by the Food and Drug Administration. This product is not intended to diagnose, treat, cure or prevent any disease.
                    </div>
                </div>
...
<!-- 
<script>
$(".truck-icons").hover(function() {
    $ (this)(".truck-icons").addClass("show-long-text");
}, function () {
    $ (this)(".truck-icons").removeClass("show-long-text");
});
</script> -->
       ...
       //   var chows_choice = $("#chows_choice").val();
         // var best_seller = $("#best_seller").val();
          ...
          /*if(query){
             ...
             $.ajax({
              url:SITE_URL+'/checkbrandnameexists',
              type:"GET",      
              data:{query:query},
              async: false,
              success:function(response){
                  if(response.trim()=="1")
                  {
                        if(query!='')
                        {
                            ...
                            link = SITE_URL+'/search?brands='+query+"&";
                        }else{
...
<script type="text/javascript">
  ...
  function shopByCategory(state=NULL) 
  {
    ...
    if(state)
    {
     ...
     $.ajax({
     // url:SITE_URL+'/getShopByCategory',
      url:url,
      type:"GET",      
      async: false,
      success:function(response){
   ...
   var doc_width = $(window).width();
      ...
      if (doc_width < 1099) {
           ...
           //  });
            ...
            // $(document).ready(function() {
            //     $('.sub-menu').click(function() {
            //         $('.su-menu').parent().removeClass("active");
            //         $('.su-menu').parent().addClass("active");
            //     });
            // });
          }
</script>
