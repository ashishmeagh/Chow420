                            ...
                            <div class="details">
                                ...
                                {{--     <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="email" class="input-text" placeholder="Email Address" name="email" id="email" data-parsley-required="true" data-parsley-type="email" value="{{$email or ''}}" data-parsley-required-message="Please enter email">
                                    ...
                                    <div class="form-group">
                                        <button type="button" class="btn-md btn-theme btn-block" id="btn-sign-up">Sign Up</button>
                                    </div>

                                    <div class="form-group">
                                        <a href="{{ url('/') }}" class="btn-md btn-theme btn-block" >Back</a>
                                    </div>
