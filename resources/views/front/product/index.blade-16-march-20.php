  ...
  @if(isset($sellers) || isset($seller))
      ...
      <div class="seller-banner-img-listpage">
        <div class="seller-banner-imgmains">
         ...
         // if(isset($arr_seller_banner) && !empty($arr_seller_banner) && count($arr_seller_banner) > 0)
        //  {
            ...
            else
            {
             ...
             if(isset($arr_seller_banner) && !empty($arr_seller_banner) && file_exists(base_path().'/uploads/seller_banner/'.$arr_seller_banner['image_medium']) && $arr_seller_banner['image_medium']!="")
            {             
              $banner_img_medium = $arr_seller_banner['image_medium'];              
              $img_path_medium =url('/uploads/seller_banner/'.$arr_seller_banner['image_medium']);
            }
            else
            {
             ...
             if(isset($arr_seller_banner) && !empty($arr_seller_banner) && file_exists(base_path().'/uploads/seller_banner/'.$arr_seller_banner['image_small']) && $arr_seller_banner['image_small']!="")
            {             
              $banner_img_small = $arr_seller_banner['image_small'];              
              $img_path_small =url('/uploads/seller_banner/'.$arr_seller_banner['image_small']);
            }
            else
            {
        ...
        @endphp
         {{--  <img src="{{$img_path}}" alt="Cover Image"> --}}
          ...
          <figure class="cw-image__figure">
                  <picture>
                      @if(isset($img_path_small))
                      <source type="image/png" srcset="{{ $img_path_small }}" media="(max-width: 621px)">
                      @endif
                      @if(isset($img_path_medium))
                      <source type="image/png" srcset="{{ $img_path_medium }}" media="(min-width: 622px) and (max-width: 834px)">
                     @endif   

                      @if(isset($img_path))
                      <source type="image/png" srcset="{{ $img_path }}" media="(min-width: 835px)">
                      @endif 

                      @if(isset($img_path))
                       <img class="cw-image cw-image--loaded obj-fit-polyfill" alt="" aria-hidden="false" src="{{ $img_path }}">
                       @endif 
                    </picture>
          </figure>
