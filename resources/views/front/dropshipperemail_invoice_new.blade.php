        ...
        <td colspan="2">
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
               ...
               @endphp
                ...
                @php
                  $sum = $order['total_wholesale_price'];
                  $shipping_charges_sum = $order['shipping_charges_sum'];
                 @endphp

                <tr>
                    <td style="border-bottom: 1px solid #e5e9f1;font-size:12px;text-align: left;padding:12px 12px 12px 30px;">{{++$sn_no}}</td>

                    <td style="border-bottom: 1px solid #e5e9f1;font-size:12px;text-align: left;padding:12px 12px 12px 30px;"><b>{{$order['product_name'] or '-'}}</td> 

                    <td style="border-bottom: 1px solid #e5e9f1;font-size:12px;text-align: left;padding:12px 12px 12px 30px;"><b>{{$order['dropshipper'] or '-'}}</td>    

                      <td style="border-bottom: 1px solid #e5e9f1;font-size:12px;text-align: left;padding:12px 12px 12px 30px;"><b>{{$order['seller_name'] or '-'}}</td>                       

                    <td style="border-bottom: 1px solid #e5e9f1;font-size:12px;text-align: left;padding:12px 12px 12px 30px;">${{isset($order['unit_price'])?num_format($order['unit_price']):0}}</td>

                    <td style="border-bottom: 1px solid #e5e9f1;font-size:12px;text-align: left;padding:12px 12px 12px 30px;">{{$order['item_qty'] or 0}}</td>

                    <td style="border-bottom: 1px solid #e5e9f1;font-size:12px;text-align: left;padding:12px 12px 12px 30px;">${{isset($order['total_wholesale_price'])?num_format($order['total_wholesale_price']):0}}</td>
