...
@endphp
       ...
       {{--  <meta name="description" content="Sign in as a seller or buyer on Chow CBD Marketplace. Thanks for being part of the most trusted CBD community online. Please let us know if you have any questions." /> --}}
      ...
      <div class="row">
        <div class="col-md-10 rw-login-float">
              ...
              <div class="col-sm-6 rw-login-left">
                   <a href="{{ url('/') }}"><img src="{{$sitelogo}}" alt="Login" /></a>
                   <!-- <h1>Where CBD happens</h1> -->

                   <h1>Where wellness takes a new meaning</h1> 
                   
                 {{--   <button type="button" class="btn btn-primary btn-lg" data-toggle="modal" data-target="#myModal-OTP">
                      OTP
                  </button> --}}
              </div>
            <div class="login-box-12 col-sm-6 rw-login-right">
              @if(isset($registration_parameter1) && $registration_parameter1=="1" && isset($registration_parameter2) && $registration_parameter2==$registration_parameter2)
                  <div class="alert alert-success alert-dismissible">
                  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                 <span aria-hidden="true">&times;</span>
                 </button>You have successfully registered as a buyer. please check your email account <b>{{ base64_decode($registration_parameter2) }}</b> to complete the verification.</div>
              @endif 
               @if(isset($registration_parameter1) && $registration_parameter1=="2" && isset($registration_parameter2) && $registration_parameter2==$registration_parameter2)
                 {{--  <div class="alert alert-success alert-dismissible">
                  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                 <span aria-hidden="true">&times;</span>
                 </button>You have successfully registered as a dispensary. please check your email account <b>{{ base64_decode($registration_parameter2) }} </b> to complete the verification.</div> --}}
                 <div class="alert alert-success alert-dismissible">
                  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                 <span aria-hidden="true">&times;</span>
                    ...
                    <div class="login-inner-form">
                        ...
                        <div class="details">
                            ...
                            <form id="login-form" onsubmit="return false;">
                                ...
                                <input type="hidden" name="hidden_productid" id="hidden_productid" value="{{$productid }}">

                                 <input type="hidden" name="hidden_buyagainurl" id="hidden_buyagainurl" value="{{ isset($registration_parameter1)? $registration_parameter1:'' }}">
 
                                 <input type="hidden" name="hidden_forumurl" id="hidden_forumurl" value="{{ isset($registration_parameter1)? $registration_parameter1:'' }}">
                                  <input type="hidden" name="hidden_buyerageurl" id="hidden_buyerageurl" value="{{ isset($buyer_age_verification_url)? $buyer_age_verification_url:'' }}">

                                <div class="form-group" id="email-div">
                                    {{-- <label for="">Email Address <span class="asteric_mark">*</span></label> --}}
                                    <input type="email" name="email" class="input-text" placeholder="Enter email address" data-parsley-required="true" data-parsley-required-message="Email is required" value="{{isset($_COOKIE["email"])?$_COOKIE["email"]:''}}" id="user_email">
                                </div>
                                <div class="form-group password-form" id="password-div">
                                    {{-- <label for="">Password <span class="asteric_mark">*</span></label> --}}
                                    <input type="password" name="password" class="input-text" id="user_password"placeholder="Enter your password" data-parsley-required="true" data-parsley-required-message="Password is required" value="{{isset($_COOKIE['password'])?$_COOKIE['password']:''}}">
                                </div>
                               ...
                               <div class="form-group password-form" id="otp-div" style="display: none;">
                                ...
                                <div class="checkbox clearfix">
                                    <div class="form-check checkbox-theme">
                                        <input class="form-check-input" type="checkbox" value="" id="rememberMe" checked="checked" @if(isset($_COOKIE["rememberd"])&& $_COOKIE["rememberd"]=='rememberd') checked="checked" @endif name="remember_me">
                                        <label class="form-check-label" for="rememberMe">
                                            Remember me
                                        </label>
                                    </div>
                                  {{--   <a href="#" data-toggle="modal" data-target="#ForgotPasswordModal" onclick="return showmodal()">Forgot Password?</a> --}}
                           ...
                           {{--  <p>Don't have an account?<a href="{{url('/').'/signup'}}" style="color:#873dc8"> Register here</a></p> --}}

                             <p>Don't have an account? Register  
                             {{--  <a href="{{url('/').'/signup/null/'.$productid}}" style="color:#873dc8"> Buyer</a> --}}


                             @if(isset($productid) && !empty($productid))
                              <a href="{{url('/').'/signup/buyer/'.$productid}}" style="color:#873dc8"> here</a>
                              @else
                               <a href="{{url('/').'/signup/buyer'}}" style="color:#873dc8"> here</a>
                              @endif


                             {{--  or
                                 <a href="{{url('/').'/signup_seller'}}" style="color:#873dc8">Dispensary</a> --}}
                            </p>


                            <hr style="margin:10px 0px;">
                             <p>If your email is not verified please  <a href="{{url('/').'/activationcode'}}" style="color:#873dc8">click here </a>  
                             </p>
                     ...
                     success_HTML +='<div class="alert alert-success alert-dismissible">\
                        ...
                        if(response.user_redirection=='-1')
                        {
                          ...
                          { 
                              ...
                              {
                                  window.setTimeout(function(){ location.href = "{{ url('/') }}/buyer/review-ratings" },1000);
                              }
                        ...
                        else
                        {
                          ...
                          {
                             window.setTimeout(function(){ location.href = "{{ url('/') }}/forum" },1000);
...
<div class="copyright-block"> 
            ...
            @endphp
             ...
             @if(!empty($cms_terms_privacy_arr) && count($cms_terms_privacy_arr)>0)
                 @foreach($cms_terms_privacy_arr as $cms_terms_privacy)
                    ...
                    @endphp  
                    <a href="{{ $href }}" class="terms-links terms-links-footer" target="_blank">{{ $cms_terms_privacy->page_title }}</a> 
                 @endforeach 
              @endif  
           ...
           {{--  <a href="{{ url('/') }}/terms" class="terms-links terms-links-footer">Terms of Use</a> 
            <a href="{{ url('/') }}/privacy" class="terms-links">Privacy Policy</a> --}}
             ...
             <a href="{{ url('/') }}/helpcenter" class="terms-links terms-links-footer">Help Center</a> 

             {{--  <a href="{{ url('/') }}/investortracker" class="terms-links terms-links-footer">Investor Tracker</a> --}}
              <div class="socail-chow">
                      ...
                      {{-- <a href="#">
                          <img src="{{url('/')}}/assets/front/images/linkedin-icon-n4.png" alt="" />
                      </a> --}}
...
<script>
  ...
  setInterval(function(){ 
    $.ajax({
      url:'{{url('/')}}'+'/check_loginattempt/verify_loginattemptfront',            
      data:{
        checkstat:1,              
      },
      dataType:'json',
