               ...
               <div class="logo-head"><a href="{{ url('/') }}"><img src="{{ $sitelogo }}" alt=""></a></div>
                ...
                <div class="col-md-12">
                  <div class="col-md-3"></div>
                   <div class="col-md-6"> 
                   <input type="text" data-parsley-required="true"  data-parsley-required-message="Please enter email" data-parsley-type="email"  data-parsley-type-message="Please enter valid email " class="form-control" name="email" id="email" value="">
                 </div>
                 <div class="col-md-3"></div>
               </div> <br/><br/>
                <div class="col-md-12">
                 <div class="col-md-12">
                   <a class="btn btn-info" class="submitemail" id="submitemail">Submit</a>
                 </div>
               </div>
               </div>
  ...
  $(document).on('click','#submitemail',function(){
    ...
    if($('#refer-form').parsley().validate()==false) return;
        ...
        if($('#refer-form').parsley().isValid() == true )
        {
          ...
          $.ajax({
            url:SITE_URL+'/process_referal_email',
            data:form_data,
            method:'POST',
