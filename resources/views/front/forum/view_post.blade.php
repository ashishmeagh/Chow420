...
<div class="container">
   <div class="frms-mandv height-none"></div> 
            ...
            <div class="commentlist-box-main">
                <div class="left-box-fum">
                    ...
                    @if(isset($login_user))
                        ...
                        <a href="javascript:void(0)" class="like-one  givelikedislike {{ $color }}" postid="{{ $forum_post['id'] }}"   containerid="{{ $forum_post['container_id'] }}"   dblikedislike="1"   ><img src="{{ url('/') }}/assets/front/images/arrowup.png" /></a>
                        @else
                          <a href="{{ url('/') }}/login" class="like-one " postid="{{ $forum_post['id'] }}" ><img src="{{ url('/') }}/assets/front/images/arrowup.png" /></a>
                        @endif
                    @else
                        <a href="{{ url('/') }}/login" class="like-one " postid="{{ $forum_post['id'] }}" ><img src="{{ url('/') }}/assets/front/images/arrowup.png" /></a>
                    @endif
                       ...
                       @if(isset($login_user))
                        ...
                        <a href="javascript:void(0)" class="dislike-one  givelikedislike {{ $color }}" postid="{{ $forum_post['id'] }}"   containerid="{{ $forum_post['container_id'] }}"   dblikedislike="2"  ><img src="{{ url('/') }}/assets/front/images/arrowdn.png" /></a>
                        @else
                          <a href="{{ url('/') }}/login" class="dislike-one " postid="{{ $forum_post['id'] }}" ><img src="{{ url('/') }}/assets/front/images/arrowdn.png" /></a>
                        @endif
                       @else
                        <a href="{{ url('/') }}/login" class="dislike-one " postid="{{ $forum_post['id'] }}" ><img src="{{ url('/') }}/assets/front/images/arrowdn.png" /></a>
                       @endif
                ...
                <div class="right-box-fum">
                        ...
                        <div class="commentlist-title">
                         ...
                         <div class="forum-image">
                          <a href="{{ url('/') }}/uploads/post/{{ $forum_post['image'] }}" target="_blank">
                              <img src="{{ url('/') }}/uploads/post/{{ $forum_post['image'] }}" >
                           </a>
                         </div>
                    ...
                    <div class="footer-forum">
                        <img src="{{url('/')}}/assets/front/images/chat-forum.png" alt="" /> <span><span class="comment_count_span">
    ...
    <div class="row sec1">
        <div class="col-sm-12 comments">           
            <div class="form-group">
                    <input type="hidden" name="container_id" value="{{$forum_posts[0]['container_id']}}">
    ...
    <a href="{{ url('/') }}/forum" class="backlink">Back</a>
</div>
...
<script src="{{ url('/') }}/assets/front/js/slick.js" defer></script>
...
<!--------COMMENTED CODE STARTS------------------------>
   ...
   {{--  <div class="fourmla-box">
       @php
        if($forum_containers)
        {   
            $cnt =1; $activeclass ='';  $dbcontainer_id='';$setforumurl='';
                ...
                $containerid = $forum_container['id'];
                   ...
                   if(isset($forum_posts))
                    {               
                        foreach($forum_posts as $forum_post)
                        {
                            $container_details = $forum_post['container_details'];
                            if(isset($container_details) && (!empty($container_details)))
                            {
                                 $dbcontainer_id = $container_details['id']; 

                                if($dbcontainer_id==$containerid){
                                  $activeclass = 'active-container';
                                }else{
                                  $activeclass ='';
                                }
            ...
            @endphp
               <a href="{{ url('/') }}/forum?containerid={{ base64_encode($containerid) }}" 
               class="boxlist-forum boxforum-{{$container_bag}} {{$activeclass }}">
                   <span>{{strtoupper($forum_container['title'])}} </span>
               </a>
 ...
 {{ $postedname }}
  ...
  {{--  <section class="regular slider">
        ...
        {   
            ...
            <div>
              <a href="{{ url('/') }}/forum?containerid={{ base64_encode($containerid) }}" class="forum-colum-list boxforum-{{$container_bag}} {{$activeclass }}" style="background-image: url({{ url('/')}}/uploads/container/{{ $forum_container['image']  }}); ">
